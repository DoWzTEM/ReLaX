...
local Alli = DataText:match('/DelRed:'..tonumber(data.sender_user_id_)..'(.*)')
EditMsg(Chat_Id2, Msg_Id2, "♪︙الكلمه ↫ "..Alli.." تم حذفها") 
DevAli:del(ReLaX..'Ali:Text:GpTexts'..Alli..data.chat_id_)
DevAli:srem(ReLaX..'Ali:Manager:GpRedod'..data.chat_id_,Alli)
end
if DataText and DataText:match('/EndRedod:'..tonumber(data.sender_user_id_)..'(.*)') then
local Alli = DataText:match('/EndRedod:'..tonumber(data.sender_user_id_)..'(.*)')
local List = DevAli:smembers(ReLaX..'Ali:Text:GpTexts'..Alli..data.chat_id_)
if DevAli:get(ReLaX..'Ali:Add:GpRedod'..data.sender_user_id_..data.chat_id_) then
EditMsg(Chat_Id2, Msg_Id2, "♪︙تم انهاء وحفظ ↫ "..#List.." من الردود المتعدده للامر ↫ "..Alli) 
...
local Alli = DataText:match('/DelRedod:'..tonumber(data.sender_user_id_)..'(.*)')
if DevAli:get(ReLaX..'Ali:Add:GpRedod'..data.sender_user_id_..data.chat_id_) then
EditMsg(Chat_Id2, Msg_Id2, "♪︙تم الغاء عملية حفظ الردود المتعدده للامر ↫ "..Alli) 
DevAli:del(ReLaX..'Ali:Add:GpRedod'..data.sender_user_id_..data.chat_id_)
DevAli:del(ReLaX..'Ali:Text:GpTexts'..Alli..data.chat_id_)
...
local Alli = DataText:match('/HideHelpList:(.*)')
if tonumber(Alli) == tonumber(data.sender_user_id_) then
...
local Alli = DataText:match('/HelpList:(.*)')
if tonumber(Alli) == tonumber(data.sender_user_id_) then
...
local Alli = DataText:match('/HelpList1:(.*)')
if tonumber(Alli) == tonumber(data.sender_user_id_) then
...
local Alli = DataText:match('/HelpList2:(.*)')
if tonumber(Alli) == tonumber(data.sender_user_id_) then
if not Admin(data) then
return https.request("https://api.telegram.org/bot"..TokenBot..'/answercallbackquery?callback_query_id='..data.id_..'&text='..URL.escape("♪ عذرا ليس لديك صلاحية التحكم لهذا الامر .")..'&show_alert=true')
end
...
local Alli = DataText:match('/HelpList3:(.*)')
if tonumber(Alli) == tonumber(data.sender_user_id_) then
if not Admin(data) then
return https.request("https://api.telegram.org/bot"..TokenBot..'/answercallbackquery?callback_query_id='..data.id_..'&text='..URL.escape("♪ عذرا ليس لديك صلاحية التحكم لهذا الامر .")..'&show_alert=true')
end
...
local Alli = DataText:match('/HelpList4:(.*)')
if tonumber(Alli) == tonumber(data.sender_user_id_) then
if not Admin(data) then
return https.request("https://api.telegram.org/bot"..TokenBot..'/answercallbackquery?callback_query_id='..data.id_..'&text='..URL.escape("♪ عذرا ليس لديك صلاحية التحكم لهذا الامر .")..'&show_alert=true')
end
...
local Alli = DataText:match('/HelpList5:(.*)')
if tonumber(Alli) == tonumber(data.sender_user_id_) then
if not Admin(data) then
return https.request("https://api.telegram.org/bot"..TokenBot..'/answercallbackquery?callback_query_id='..data.id_..'&text='..URL.escape("♪ عذرا ليس لديك صلاحية التحكم لهذا الامر .")..'&show_alert=true')
end
...
local Alli = DataText:match('/HelpList6:(.*)')
if tonumber(Alli) == tonumber(data.sender_user_id_) then
