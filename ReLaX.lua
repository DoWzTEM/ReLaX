------------------------------------------------
-- This Source Was Developed By (Ali) @IQ_Ali.--
...
ServerReLaX = io.popen("echo $SSH_CLIENT | awk '{ print $1}'"):read('*a') 
...
if not DevAli:get(ServerReLaX.."IdReLaX") then 
io.write('\27[1;35m\nالان ارسل ايدي المطور الاساسي ↫ ⤈\n\27[0;33;49m') 
local DevId = io.read():gsub(' ','') 
if tostring(DevId):match('%d+') then 
io.write('\27[1;36mتم حفظ ايدي المطور الاساسي\n27[0;39;49m') 
DevAli:set(ServerReLaX.."IdReLaX",DevId) 
else 
print('\27[1;31m┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉\nلم يتم حفظ ايدي المطور الاساسي ارسله مره اخرى\n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉') 
end 
os.execute('lua ReLaX.lua') 
end 
if not DevAli:get(ServerReLaX.."TokenReLaX") then 
...
DevAli:set(ServerReLaX.."TokenReLaX",TokenBot) 
end  
else 
...
Config = {
DevId = DevAli:get(ServerReLaX.."IdReLaX"),
TokenBot = DevAli:get(ServerReLaX.."TokenReLaX"),
...
#!/usr/bin/env bash
cd $HOME/ReLaX
token="]]..DevAli:get(ServerReLaX.."TokenReLaX")..[["
while(true) do
rm -fr ../.telegram-cli
if [ ! -f ./tg ]; then
echo "┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉"
...
local Load_ReLaX = function() 
local f = io.open("./config.lua", "r") 
if not f then 
AutoSet() 
else 
f:close() 
DevAli:del(ServerReLaX.."IdReLaX");DevAli:del(ServerReLaX.."TokenReLaX")
end 
...
local Status = DevAli:sismember(ReLaX..'Ali:SecondSudo:',msg.sender_user_id_) 
...
function Bot(msg) 
local var = false  
if msg.sender_user_id_ == tonumber(ReLaX) then  
var = true  
end  
return var  
end 
...
local Status = DevAli:sismember(ReLaX..'Ali:SudoBot:',msg.sender_user_id_) 
...
local Status = DevAli:sismember(ReLaX..'Ali:ManagerAll:',msg.sender_user_id_) 
...
local Status = DevAli:sismember(ReLaX..'Ali:AdminAll:',msg.sender_user_id_) 
...
local Status = DevAli:sismember(ReLaX..'Ali:AliConstructor:'..msg.chat_id_,msg.sender_user_id_) 
if Status or SudoBot(msg) or Sudo(msg) or SecondSudo(msg) or Bot(msg) then  
return true  
else  
return false  
...
local Status = DevAli:sismember(ReLaX..'Ali:BasicConstructor:'..msg.chat_id_,msg.sender_user_id_) 
...
local Status = DevAli:sismember(ReLaX..'Ali:Constructor:'..msg.chat_id_,msg.sender_user_id_) 
...
local Status = DevAli:sismember(ReLaX..'Ali:Managers:'..msg.chat_id_,msg.sender_user_id_) 
...
----------  Admin  ---------
function Admin(msg) 
local Status = DevAli:sismember(ReLaX..'Ali:Admins:'..msg.chat_id_,msg.sender_user_id_) 
...
---------Vip Member---------
function VipMem(msg) 
local Status = DevAli:sismember(ReLaX..'Ali:VipMem:'..msg.chat_id_,msg.sender_user_id_) 
...
local Status = DevAli:sismember(ReLaX..'Ali:Cleaner:'..msg.chat_id_,msg.sender_user_id_) 
...
if DevAli:sismember(ReLaX..'Ali:Ban:'..chat_id, user_id) then
var = true
else
var = false
end
...
if DevAli:sismember(ReLaX..'Ali:BanAll:', user_id) then
var = true
else
var = false
end
...
if DevAli:sismember(ReLaX..'Ali:Muted:'..chat_id, user_id) then
var = true
else
var = false
end
...
if DevAli:sismember(ReLaX..'Ali:MuteAll:', user_id) then
var = true
else
var = false
end
...
--     Source ReLaX     --
function ReLaXFiles(msg)
for v in io.popen('ls Files'):lines() do
if v:match(".lua$") then
plugin = dofile("Files/"..v)
if plugin.ReLaX and msg then
FilesText = plugin.ReLaX(msg)
end
end
end
...
if File_Name:lower():match('(%d+)') ~= ReLaX:lower() then 
...
local info_file = io.open('./'..ReLaX..'.json', "r"):read('*a')
local JsonInfo = JSON.decode(info_file)
vardump(JsonInfo)
DevAli:set(ReLaX.."Ali:NameBot",JsonInfo.BotName) 
for IdGps,v in pairs(JsonInfo.GroupsList) do
DevAli:sadd(ReLaX.."Ali:Groups",IdGps) 
DevAli:set(ReLaX.."Ali:Lock:Bots"..IdGps,"del") DevAli:hset(ReLaX.."Ali:Spam:Group:User"..IdGps ,"Spam:User","keed") 
...
DevAli:set(ReLaX..Lock..IdGps,true)
end
if v.AliConstructors then
for k,IdAliConstructors in pairs(v.AliConstructors) do
DevAli:sadd(ReLaX..'Ali:AliConstructor:'..IdGps,IdAliConstructors)  
print('تم رفع منشئين المجموعات')
end
end
if v.BasicConstructors then
for k,IdBasicConstructors in pairs(v.BasicConstructors) do
DevAli:sadd(ReLaX..'Ali:BasicConstructor:'..IdGps,IdBasicConstructors)  
print('تم رفع ( '..k..' ) منشئين اساسيين')
end
end
if v.Constructors then
for k,IdConstructors in pairs(v.Constructors) do
DevAli:sadd(ReLaX..'Ali:Constructor:'..IdGps,IdConstructors)  
print('تم رفع ( '..k..' ) منشئين')
end
end
if v.Managers then
for k,IdManagers in pairs(v.Managers) do
DevAli:sadd(ReLaX..'Ali:Managers:'..IdGps,IdManagers)  
...
vardump(IdAdmins)
DevAli:sadd(ReLaX..'Ali:Admins:'..IdGps,IdAdmins)  
print('تم رفع ( '..k..' ) ادمنيه')
end
end
if v.Vips then
for k,IdVips in pairs(v.Vips) do
DevAli:sadd(ReLaX..'Ali:VipMem:'..IdGps,IdVips)  
print('تم رفع ( '..k..' ) مميزين')
end
end
if v.LinkGroups then
if v.LinkGroups ~= "" then
DevAli:set(ReLaX.."Ali:Groups:Links"..IdGps,v.LinkGroups)   
print('( تم وضع روابط المجموعات )')
end
end
if v.Welcomes then
if v.Welcomes ~= "" then
DevAli:set(ReLaX.."Ali:Groups:Welcomes"..IdGps,v.Welcomes)   
...
local Ali = (ReLaX..'Ali:Filters:'..msg.chat_id_)
if Ali then
...
--     Source ReLaX     --
function Alimoned(chat_id, user_id, msg_id, text, offset, length) local tt = DevAli:get(ReLaX..'endmsg') or '' tdcli_function ({ ID = "SendMessage", chat_id_ = chat_id, reply_to_message_id_ = msg_id, disable_notification_ = 0, from_background_ = 1, reply_markup_ = nil, input_message_content_ = { ID = "InputMessageText", text_ = text..'\n\n'..tt, disable_web_page_preview_ = 1, clear_draft_ = 0, entities_ = {[0]={ ID="MessageEntityMentionName", offset_=offset, length_=length, user_id_=user_id }, }, }, }, dl_cb, nil) end
--     Source ReLaX     --
...
if DataText == '/delyes' and DevAli:get(ReLaX..'yes'..data.sender_user_id_) == 'delyes' then
DevAli:del(ReLaX..'yes'..data.sender_user_id_, 'delyes')
DevAli:del(ReLaX..'no'..data.sender_user_id_, 'delno')
...
if DataText == '/delno' and DevAli:get(ReLaX..'no'..data.sender_user_id_) == 'delno' then
DevAli:del(ReLaX..'yes'..data.sender_user_id_, 'delyes')
DevAli:del(ReLaX..'no'..data.sender_user_id_, 'delno')
EditMsg(Chat_Id2, Msg_Id2, "⌁︙تم الغاء امر اطردني") 
end
--     Source ReLaX     --
if DataText == '/yesdel' and DevAli:get(ReLaX..'yesdel'..data.sender_user_id_) == 'delyes' then
DevAli:del(ReLaX..'yesdel'..data.sender_user_id_, 'delyes')
DevAli:del(ReLaX..'nodel'..data.sender_user_id_, 'delno')
if DevAli:sismember(ReLaX..'Ali:Constructor:'..data.chat_id_, data.sender_user_id_) then
constructor = 'المنشئين • ' else constructor = '' end 
if DevAli:sismember(ReLaX..'Ali:Managers:'..data.chat_id_, data.sender_user_id_) then
Managers = 'المدراء • ' else Managers = '' end
if DevAli:sismember(ReLaX..'Ali:Admins:'..data.chat_id_, data.sender_user_id_) then
admins = 'الادمنيه • ' else admins = '' end
if DevAli:sismember(ReLaX..'Ali:VipMem:'..data.chat_id_, data.sender_user_id_) then
vipmem = 'المميزين • ' else vipmem = '' end
if DevAli:sismember(ReLaX..'Ali:Cleaner:'..data.chat_id_, data.sender_user_id_) then
cleaner = 'المنظفين • ' else cleaner = '' end
if DevAli:sismember(ReLaX..'User:Donky:'..data.chat_id_, data.sender_user_id_) then
donky = 'المطايه • ' else donky = '' end
if DevAli:sismember(ReLaX..'Ali:Constructor:'..data.chat_id_, data.sender_user_id_) or DevAli:sismember(ReLaX..'Ali:Managers:'..data.chat_id_, data.sender_user_id_) or DevAli:sismember(ReLaX..'Ali:Admins:'..data.chat_id_, data.sender_user_id_) or DevAli:sismember(ReLaX..'Ali:VipMem:'..data.chat_id_, data.sender_user_id_) or DevAli:sismember(ReLaX..'Ali:Cleaner:'..data.chat_id_, data.sender_user_id_) or DevAli:sismember(ReLaX..'User:Donky:'..data.chat_id_, data.sender_user_id_) then
DevAli:srem(ReLaX..'Ali:Constructor:'..data.chat_id_,data.sender_user_id_)
DevAli:srem(ReLaX..'Ali:Managers:'..data.chat_id_,data.sender_user_id_)
DevAli:srem(ReLaX..'Ali:Admins:'..data.chat_id_,data.sender_user_id_)
...
if DevAli:get(ReLaX.."Ali:NewDev"..data.sender_user_id_) then
if DataText == '/setno' then
EditMsg(Chat_Id2, Msg_Id2, "⌁︙تم الغاء امر تغير المطور الاساسي") 
DevAli:del(ReLaX.."Ali:NewDev"..data.sender_user_id_)
return false
end
...
if DataText == '/nodel' and DevAli:get(ReLaX..'nodel'..data.sender_user_id_) == 'delno' then
DevAli:del(ReLaX..'yesdel'..data.sender_user_id_, 'delyes')
DevAli:del(ReLaX..'nodel'..data.sender_user_id_, 'delno')
EditMsg(Chat_Id2, Msg_Id2, "⌁︙تم الغاء امر نزلني") 
end
if DataText == '/YesRolet' and DevAli:get(ReLaX.."Ali:WittingStartRolet"..data.chat_id_..data.sender_user_id_) then
local List = DevAli:smembers(ReLaX..'Ali:ListRolet'..data.chat_id_) 
local UserName = List[math.random(#List)]
tdcli_function ({ID="SearchPublicChat",username_ = UserName},function(arg,dp) 
DevAli:incrby(ReLaX..'Ali:GamesNumber'..data.chat_id_..dp.id_, 5) 
end,nil) 
DevAli:del(ReLaX..'Ali:ListRolet'..data.chat_id_) 
DevAli:del(ReLaX.."Ali:WittingStartRolet"..data.chat_id_..data.sender_user_id_)
EditMsg(Chat_Id2, Msg_Id2, "⌁︙*صاحب الحظ* ↫ ["..UserName.."]\n⌁︙*مبروك لقد ربحت وحصلت على 5 نقاط يمكنك استبدالها بالرسائل*")
end
if DataText == '/NoRolet' then
DevAli:del(ReLaX..'Ali:ListRolet'..data.chat_id_) 
DevAli:del(ReLaX.."Ali:NumRolet"..data.chat_id_..data.sender_user_id_) 
DevAli:del(ReLaX.."Ali:WittingStartRolet"..data.chat_id_..data.sender_user_id_)
...
if NewCmmd then
DevAli:del(ReLaX.."Set:Cmd:Group:New1"..msg.chat_id_..":"..text)
DevAli:del(ReLaX.."Set:Cmd:Group:New"..msg.chat_id_)
DevAli:srem(ReLaX.."List:Cmd:Group:New"..msg.chat_id_,text)
...
DevAli:del(ReLaX.."Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_)
return false
end
if text and text:match('^'..(DevAli:get(ReLaX..'Ali:NameBot') or "ريلاكس")..' ') then
data.message_.content_.text_ = data.message_.content_.text_:gsub('^'..(DevAli:get(ReLaX..'Ali:NameBot') or "ريلاكس")..' ','')
end
if data.message_.content_.text_ then
local NewCmmd = DevAli:get(ReLaX.."Set:Cmd:Group:New1"..msg.chat_id_..":"..data.message_.content_.text_)
if NewCmmd then
data.message_.content_.text_ = (NewCmmd or data.message_.content_.text_)
end
end
if text and DevAli:get(ReLaX.."Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_) == "true" then
DevAli:set(ReLaX.."Set:Cmd:Group:New"..msg.chat_id_,text)
Dev_Ali(msg.chat_id_, msg.id_, 1, "⌁︙ارسل الامر الجديد", 1, 'html')
DevAli:del(ReLaX.."Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_)
DevAli:set(ReLaX.."Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_,"true1") 
return false
end
if text and DevAli:get(ReLaX.."Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_) == "true1" then
local NewCmd = DevAli:get(ReLaX.."Set:Cmd:Group:New"..msg.chat_id_)
DevAli:set(ReLaX.."Set:Cmd:Group:New1"..msg.chat_id_..":"..text,NewCmd)
DevAli:sadd(ReLaX.."List:Cmd:Group:New"..msg.chat_id_,text)
Dev_Ali(msg.chat_id_, msg.id_, 1, "⌁︙تم حفظ الامر", 1, 'html')
DevAli:del(ReLaX.."Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_)
return false
end
if Constructor(msg) then
if text == "الاوامر المضافه" and ChCheck(msg) then
local List = DevAli:smembers(ReLaX.."List:Cmd:Group:New"..msg.chat_id_.."") 
...
local List = DevAli:smembers(ReLaX.."List:Cmd:Group:New"..msg.chat_id_)
for k,v in pairs(List) do
DevAli:del(ReLaX.."Set:Cmd:Group:New1"..msg.chat_id_..":"..v)
DevAli:del(ReLaX.."List:Cmd:Group:New"..msg.chat_id_)
end
...
DevAli:sadd(ReLaX.."List:Cmd:Group:New"..msg.chat_id_,"اد")
DevAli:set(ReLaX.."Set:Cmd:Group:New1"..msg.chat_id_..":مد","رفع مدير")
DevAli:sadd(ReLaX.."List:Cmd:Group:New"..msg.chat_id_,"مد")
DevAli:set(ReLaX.."Set:Cmd:Group:New1"..msg.chat_id_..":من","رفع منشئ")
...
DevAli:set(ReLaX.."Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_,"true") 
...
local List = DevAli:smembers(ReLaX.."Coomds"..msg.chat_id_)
if #List == 0 then
...
local List = DevAli:smembers(ReLaX.."Coomds"..msg.chat_id_)
for k,v in pairs(List) do
DevAli:del(ReLaX.."Comd:New:rt:Ali:"..v..msg.chat_id_)
DevAli:del(ReLaX.."Coomds"..msg.chat_id_)
end
...
local DEV_ALLII = text:match("رفع (.*)")
if DevAli:sismember(ReLaX.."Coomds"..msg.chat_id_,DEV_ALLII) then
function by_reply(extra, result, success)   
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
local mrAli = DevAli:get(ReLaX.."Comd:New:rt:Ali:"..DEV_ALLII..msg.chat_id_)
if mrAli == "مميز" and VipMem(msg) then
Dev_Ali(msg.chat_id_, msg.id_, 1, '⌁︙العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'ReL3X7')..')'..' ❩\n⌁︙تم رفعه ❨ '..DEV_ALLII..' ❩ بنجاح', 1, 'md')
DevAli:set(ReLaX.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,DEV_ALLII) 
...
local DEV_ALLII = text:match("تنزيل (.*)")
if DevAli:sismember(ReLaX.."Coomds"..msg.chat_id_,DEV_ALLII) then
function by_reply(extra, result, success)   
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
local mrAli = DevAli:get(ReLaX.."Comd:New:rt:Ali:"..DEV_ALLII..msg.chat_id_)
if mrAli == "مميز" and VipMem(msg) then
Dev_Ali(msg.chat_id_, msg.id_, 1, '⌁︙العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'ReL3X7')..')'..' ❩\n⌁︙تم تنزيله ❨ '..DEV_ALLII..' ❩ بنجاح', 1, 'md')
...
if DevAli:sismember(ReLaX.."Coomds"..msg.chat_id_,text1[2]) then
function py_username(extra, result, success)   
if result.id_ then
local mrAli = DevAli:get(ReLaX.."Comd:New:rt:Ali:"..text1[2]..msg.chat_id_)
if mrAli == "مميز" and VipMem(msg) then
Dev_Ali(msg.chat_id_, msg.id_, 1, '⌁︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'ReL3X7')..')'..' ❩\n⌁︙تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
DevAli:sadd(ReLaX..'Ali:VipMem:'..msg.chat_id_, result.id_)
DevAli:set(ReLaX.."Comd:New:rt:User:"..msg.chat_id_..result.id_,text1[2])
elseif mrAli == "ادمن" and Admin(msg) then 
Dev_Ali(msg.chat_id_, msg.id_, 1, '⌁︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'ReL3X7')..')'..' ❩\n⌁︙تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
DevAli:sadd(ReLaX..'Ali:Admins:'..msg.chat_id_, result.id_)
DevAli:set(ReLaX.."Comd:New:rt:User:"..msg.chat_id_..result.id_,text1[2])
elseif mrAli == "مدير" and Manager(msg) then
Dev_Ali(msg.chat_id_, msg.id_, 1, '⌁︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'ReL3X7')..')'..' ❩\n⌁︙تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
DevAli:sadd(ReLaX..'Ali:Managers:'..msg.chat_id_, result.id_)
DevAli:set(ReLaX.."Comd:New:rt:User:"..msg.chat_id_..result.id_,text1[2])
elseif mrAli == "عضو" then
Dev_Ali(msg.chat_id_, msg.id_, 1, '⌁︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'ReL3X7')..')'..' ❩\n⌁︙تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
end
...
DevAli:srem(ReLaX..'Ali:VipMem:'..msg.chat_id_, result.id_)
DevAli:del(ReLaX.."Comd:New:rt:User:"..msg.chat_id_..result.id_)
elseif mrAli == "ادمن" and Admin(msg) then 
Dev_Ali(msg.chat_id_, msg.id_, 1, '⌁︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'ReL3X7')..')'..' ❩\n⌁︙تم تنزيله ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
DevAli:srem(ReLaX..'Ali:Admins:'..msg.chat_id_, result.id_)
DevAli:del(ReLaX.."Comd:New:rt:User:"..msg.chat_id_..result.id_)
elseif mrAli == "مدير" and Manager(msg) then
Dev_Ali(msg.chat_id_, msg.id_, 1, '⌁︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'ReL3X7')..')'..' ❩\n⌁︙تم تنزيله ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
DevAli:srem(ReLaX..'Ali:Managers:'..msg.chat_id_, result.id_)
DevAli:del(ReLaX.."Comd:New:rt:User:"..msg.chat_id_..result.id_)
elseif mrAli == "عضو" then
Dev_Ali(msg.chat_id_, msg.id_, 1, '⌁︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'ReL3X7')..')'..' ❩\n⌁︙تم تنزيله ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
end
...
DevAli:incr(ReLaX..'Ali:UsersMsgs'..ReLaX..os.date('%d')..':'..msg.chat_id_..':'..msg.sender_user_id_)
DevAli:incr(ReLaX..'Ali:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
DevAli:incr(ReLaX..'Ali:MsgNumberDay'..msg.chat_id_..':'..os.date('%d'))  
ChatType = 'sp' 
elseif id:match("^(%d+)") then
if not DevAli:sismember(ReLaX.."Ali:Users",msg.chat_id_) then
DevAli:sadd(ReLaX.."Ali:Users",msg.chat_id_)
end
ChatType = 'pv' 
else
ChatType = 'gp' 
...
if not DevAli:get(ReLaX..'Ali:Start:Time'..msg.sender_user_id_) then
tdcli_function({ID="GetUser",user_id_=DevId},function(arg,dp) 
local inline = {{{text="⌁ المطور .",url="t.me/"..(dp.username_ or "ReL3X7")}}}
local start = DevAli:get(ReLaX.."Ali:Start:Bot")
if start then 
Start_Source = start
else
...
DevAli:setex(ReLaX..'Ali:Start:Time'..msg.sender_user_id_,300,true)
return false
end 
--     Source ReLaX     --
if not SecondSudo(msg) and not DevAli:sismember(ReLaX..'Ali:Ban:Pv',msg.sender_user_id_) and not DevAli:get(ReLaX..'Ali:Texting:Pv') then
...
DevAli:sadd(ReLaX..'Ali:Ban:Pv',data.id_)  
return false  
end 
if text == 'الغاء الحظر' or text == 'الغاء حظر' then
local Text = '⌁︙العضو ↫ ['..string.sub(data.first_name_,0, 40)..'](tg://user?id='..data.id_..')'..'\n⌁︙تم الغاء حظره من التواصل'
SendText(DevId,Text,msg.id_/2097152/0.5,'md') 
DevAli:srem(ReLaX..'Ali:Ban:Pv',data.id_)  
return false  
end 
...
--     Source ReLaX     --
if text and DevAli:get(ReLaX..'Ali:Start:Bots'..msg.sender_user_id_) then
if text == 'الغاء' then   
Dev_Ali(msg.chat_id_, msg.id_, 1, '⌁︙تم الغاء حفظ كليشة الستارت', 1, 'md')
DevAli:del(ReLaX..'Ali:Start:Bots'..msg.sender_user_id_) 
return false
end
DevAli:set(ReLaX.."Ali:Start:Bot",text)  
...
DevAli:set(ReLaX..'Ali:Start:Bots'..msg.sender_user_id_,true) 
...
DevAli:del(ReLaX..'Ali:Texting:Pv') 
end
if text == 'تعطيل التواصل' or text == '↫ تعطيل التواصل ⌁' then  
local ReLaXTEAM = '⌁︙اهلا عزيزي ↫ '..AliRank(msg)..' \n⌁︙تم تعطيل التواصل بنجاح'
Alimoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ReLaXTEAM, 14, string.len(msg.sender_user_id_))
DevAli:set(ReLaX..'Ali:Texting:Pv',true) 
end
end
--     Source ReLaX     --
...
DevAli:incr(ReLaX..'Ali:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_)
DevAli:set(ReLaX.."Who:Added:Me"..msg.chat_id_..':'..msg.content_.members_[0].id_,msg.sender_user_id_)
local mem_id = msg.content_.members_  
local Bots = DevAli:get(ReLaX.."Ali:Lock:Bots"..msg.chat_id_) 
for i=0,#mem_id do  
...
if msg.content_.ID == "MessageChatDeleteMember" and tonumber(msg.content_.user_.id_) == tonumber(ReLaX) then 
DevAli:srem(ReLaX.."Ali:Groups", msg.chat_id_) 
...
if DevAli:get(ReLaX..'Ali:Lock:TagServr'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})    
end   
end
if msg.content_.ID == "MessageChatJoinByLink" or msg.content_.ID == "MessageChatAddMembers" then   
DevAli:incr(ReLaX..'Ali:EntryNumber'..msg.chat_id_..':'..os.date('%d'))  
elseif msg.content_.ID == "MessageChatDeleteMember" then   
DevAli:incr(ReLaX..'Ali:ExitNumber'..msg.chat_id_..':'..os.date('%d'))  
end
--     Source ReLaX     --
if text ==('تفعيل') and not SudoBot(msg) and ChCheck(msg) then
if not DevAli:get(ReLaX..'Ali:Lock:FreeBot'..ReLaX) then
if ChatType == 'pv' then
...
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,ALLII) 
local admins = ALLII.members_
for i=0 , #admins do
if ALLII.members_[i].bot_info_ == false and ALLII.members_[i].status_.ID == "ChatMemberStatusEditor" then
DevAli:sadd(ReLaX..'Ali:Admins:'..msg.chat_id_, admins[i].user_id_)
tdcli_function ({ID = "GetUser",user_id_ = admins[i].user_id_},function(arg,ba) 
if ba.first_name_ == false then
DevAli:srem(ReLaX..'Ali:Admins:'..msg.chat_id_, admins[i].user_id_)
end
end,nil)   
else
DevAli:sadd(ReLaX..'Ali:Admins:'..msg.chat_id_, admins[i].user_id_)
end
if ALLII.members_[i].status_.ID == "ChatMemberStatusCreator" then
DevAli:sadd(ReLaX.."Ali:BasicConstructor:"..msg.chat_id_,admins[i].user_id_)
DevAli:sadd(ReLaX.."Ali:AliConstructor:"..msg.chat_id_,admins[i].user_id_)
tdcli_function ({ID = "GetUser",user_id_ = admins[i].user_id_},function(arg,ba) 
if ba.first_name_ == false then
DevAli:srem(ReLaX.."Ali:BasicConstructor:"..msg.chat_id_,admins[i].user_id_)
DevAli:srem(ReLaX.."Ali:AliConstructor:"..msg.chat_id_,admins[i].user_id_)
end
end,nil)  
end 
end
...
if tonumber(data.member_count_) < tonumber(DevAli:get(ReLaX..'Ali:Num:Add:Bot') or 0) and not SecondSudo(msg) then
Dev_Ali(msg.chat_id_, msg.id_, 1, '⌁︙عدد اعضاء المجموعه اقل من ↫ *'..(DevAli:get(ReLaX..'Ali:Num:Add:Bot') or 0)..'* عضو', 1, 'md')
return false
end
ReplyStatus(msg,result.id_,"ReplyBy","⌁︙تم تفعيل المجموعه "..dp.title_)  
DevAli:sadd(ReLaX.."Ali:Groups",msg.chat_id_)
DevAli:sadd(ReLaX..'Ali:BasicConstructor:'..msg.chat_id_,msg.sender_user_id_)
local Name1 = result.first_name_
local Name1 = Name1:gsub('"',"") 
local Name1 = Name1:gsub("'","") 
local Name1 = Name1:gsub("`","") 
...
DevAli:set(ReLaX.."Ali:Groups:Links"..msg.chat_id_,LinkGroup) 
...
DevAli:set(ReLaX..'Save:UserName'..msg.sender_user_id_,data.username_)
end;end,nil) 
--     Source ReLaX     --
...
if not Manager(msg) then 
local filter = DevAli:smembers(ReLaX.."Ali:FilterPhoto"..msg.chat_id_)
...
if not Manager(msg) then 
local filter = DevAli:smembers(ReLaX.."Ali:FilterAnimation"..msg.chat_id_)
for k,v in pairs(filter) do
...
if not Manager(msg) then 
local filter = DevAli:smembers(ReLaX.."Ali:FilterSteckr"..msg.chat_id_)
for k,v in pairs(filter) do
...
if text and text:match("^(.*)$") then
local DelAllRed = DevAli:get(ReLaX.."Ali:Add:AllRed"..msg.sender_user_id_)
if DelAllRed == 'DelAllRed' then
Dev_Ali(msg.chat_id_, msg.id_, 1,'⌁︙الكلمه ↫ '..msg.content_.text_..' تم حذفها',  1, "html")
DevAli:del(ReLaX.."Ali:Add:AllRed"..msg.sender_user_id_)
DevAli:del(ReLaX.."Ali:Gif:AllRed"..msg.content_.text_)
DevAli:del(ReLaX.."Ali:Voice:AllRed"..msg.content_.text_)
DevAli:del(ReLaX.."Ali:Audio:AllRed"..msg.content_.text_)
DevAli:del(ReLaX.."Ali:Photo:AllRed"..msg.content_.text_)
DevAli:del(ReLaX.."Ali:Stecker:AllRed"..msg.content_.text_)
DevAli:del(ReLaX.."Ali:Video:AllRed"..msg.content_.text_)
DevAli:del(ReLaX.."Ali:File:AllRed"..msg.content_.text_)
DevAli:del(ReLaX.."Ali:Text:AllRed"..msg.content_.text_)
DevAli:del(ReLaX.."Ali:Sudo:AllRed",msg.content_.text_)
return false
end
end
--     Source ReLaX     --
...
getUser(msg.sender_user_id_, ReLaXTEAM)
end
end
--     Source ReLaX     --
text = msg.content_.text_
if msg.content_.text_ or msg.content_.video_ or msg.content_.document_ or msg.content_.sticker_ or msg.content_.voice_ or msg.content_.audio_ or msg.content_.photo_ or msg.content_.animation_ then
local SaveAllRed = DevAli:get(ReLaX.."Ali:Add:AllRed"..msg.sender_user_id_)
if SaveAllRed == 'SaveAllRed' then
if text == 'الغاء' then
local DelSudoRep = DevAli:get(ReLaX..'DelSudoRep')
DevAli:del(ReLaX.."Ali:Sudo:AllRed",DelSudoRep)
Dev_Ali(msg.chat_id_, msg.id_, 1, '⌁︙تم الغاء حفظ الرد', 1, 'md')
DevAli:del(ReLaX.."Ali:Add:AllText"..msg.sender_user_id_)
DevAli:del(ReLaX.."Ali:Add:AllRed"..msg.sender_user_id_)
DevAli:del(ReLaX.."DelSudoRep")
return false
end
DevAli:del(ReLaX.."Ali:Add:AllRed"..msg.sender_user_id_)
local SaveAllRed = DevAli:get(ReLaX.."Ali:Add:AllText"..msg.sender_user_id_)
if msg.content_.video_ then
DevAli:set(ReLaX.."Ali:Video:AllRed"..SaveAllRed, msg.content_.video_.video_.persistent_id_)
end
if msg.content_.document_ then
DevAli:set(ReLaX.."Ali:File:AllRed"..SaveAllRed, msg.content_.document_.document_.persistent_id_)
end
if msg.content_.sticker_ then
DevAli:set(ReLaX.."Ali:Stecker:AllRed"..SaveAllRed, msg.content_.sticker_.sticker_.persistent_id_)
end
if msg.content_.voice_ then
DevAli:set(ReLaX.."Ali:Voice:AllRed"..SaveAllRed, msg.content_.voice_.voice_.persistent_id_)
end
if msg.content_.audio_ then
DevAli:set(ReLaX.."Ali:Audio:AllRed"..SaveAllRed, msg.content_.audio_.audio_.persistent_id_)
end
if msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
...
DevAli:set(ReLaX.."Ali:Photo:AllRed"..SaveAllRed, photo_in_all_groups)
end
if msg.content_.animation_ then
DevAli:set(ReLaX.."Ali:Gif:AllRed"..SaveAllRed, msg.content_.animation_.animation_.persistent_id_)
end
if msg.content_.text_ then
DevAli:set(ReLaX.."Ali:Text:AllRed"..SaveAllRed, msg.content_.text_)
end 
Dev_Ali(msg.chat_id_, msg.id_, 1, '⌁︙تم حفظ الرد الجديد', 1, 'md') 
DevAli:del(ReLaX.."Ali:Add:AllText"..msg.sender_user_id_)
DevAli:del(ReLaX..'DelSudoRep')
return false end end
if msg.content_.text_ and not DevAli:get(ReLaX..'Ali:Lock:AllRed'..msg.chat_id_) then
if DevAli:get(ReLaX.."Ali:Video:AllRed"..msg.content_.text_) then
sendVideo(msg.chat_id_, msg.id_, 0, 1,nil, DevAli:get(ReLaX.."Ali:Video:AllRed"..msg.content_.text_))
end
if DevAli:get(ReLaX.."Ali:File:AllRed"..msg.content_.text_) then
sendDocument(msg.chat_id_, msg.id_, 0, 1,nil, DevAli:get(ReLaX.."Ali:File:AllRed"..msg.content_.text_))
end
if DevAli:get(ReLaX.."Ali:Voice:AllRed"..msg.content_.text_)  then
sendVoice(msg.chat_id_, msg.id_, 0, 1, nil, DevAli:get(ReLaX.."Ali:Voice:AllRed"..msg.content_.text_))
end
if DevAli:get(ReLaX.."Ali:Audio:AllRed"..msg.content_.text_)  then
sendAudio(msg.chat_id_, msg.id_, 0, 1, nil, DevAli:get(ReLaX.."Ali:Audio:AllRed"..msg.content_.text_))
end
if DevAli:get(ReLaX.."Ali:Photo:AllRed"..msg.content_.text_)  then
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, DevAli:get(ReLaX.."Ali:Photo:AllRed"..msg.content_.text_))
end
if  DevAli:get(ReLaX.."Ali:Gif:AllRed"..msg.content_.text_) then
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, DevAli:get(ReLaX.."Ali:Gif:AllRed"..msg.content_.text_))
end
if DevAli:get(ReLaX.."Ali:Stecker:AllRed"..msg.content_.text_) then
sendSticker(msg.chat_id_, msg.id_, 0, 1,nil, DevAli:get(ReLaX.."Ali:Stecker:AllRed"..msg.content_.text_))
end
if DevAli:get(ReLaX.."Ali:Text:AllRed"..msg.content_.text_) then
function ReLaXTEAM(extra,result,success)
if result.username_ then username = '[@'..result.username_..']' else username = 'لا يوجد' end
local edit_msg = DevAli:get(ReLaX..'Ali:EditMsg'..msg.chat_id_..msg.sender_user_id_) or 0
local user_msgs = DevAli:get(ReLaX..'Ali:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
local Text = DevAli:get(ReLaX.."Ali:Text:AllRed"..msg.content_.text_)
local Text = Text:gsub('#username',(username or 'لا يوجد')) 
local Text = Text:gsub('#name','['..result.first_name_..']')
local Text = Text:gsub('#id',msg.sender_user_id_)
local Text = Text:gsub('#edit',edit_msg)
...
if Type == "mute" and not DevAli:sismember(ReLaX..'Ali:Muted:'..msg.chat_id_, msg.sender_user_id_) then
DevAli:sadd(ReLaX..'Ali:Muted:'..msg.chat_id_,msg.sender_user_id_)
my_ide = msg.sender_user_id_
msgm = msg.id_
local num = 100
for i=1,tonumber(num) do
...
--     Source ReLaX     --
--       Spam Check       --
if not VipMem(msg) and msg.content_.ID ~= "MessageChatAddMembers" and DevAli:hget(ReLaX.."Ali:Spam:Group:User"..msg.chat_id_,"Spam:User") then 
if msg.sender_user_id_ ~= ReLaX then
floods = DevAli:hget(ReLaX.."Ali:Spam:Group:User"..msg.chat_id_,"Spam:User") or "nil"
Num_Msg_Max = DevAli:hget(ReLaX.."Ali:Spam:Group:User"..msg.chat_id_,"Num:Spam") or 5
Time_Spam = DevAli:hget(ReLaX.."Ali:Spam:Group:User"..msg.chat_id_,"Num:Spam:Time") or 5
local post_count = tonumber(DevAli:get(ReLaX.."Ali:Spam:Cont"..msg.sender_user_id_..":"..msg.chat_id_) or 0)
if post_count > tonumber(DevAli:hget(ReLaX.."Ali:Spam:Group:User"..msg.chat_id_,"Num:Spam") or 5) then 
local ch = msg.chat_id_
local type = DevAli:hget(ReLaX.."Ali:Spam:Group:User"..msg.chat_id_,"Spam:User") 
NotSpam(msg,type)  
end
DevAli:setex(ReLaX.."Ali:Spam:Cont"..msg.sender_user_id_..":"..msg.chat_id_, tonumber(DevAli:hget(ReLaX.."Ali:Spam:Group:User"..msg.chat_id_,"Num:Spam:Time") or 3), post_count+1) 
local edit_id = data.text_ or "nil"  
Num_Msg_Max = 5
if DevAli:hget(ReLaX.."Ali:Spam:Group:User"..msg.chat_id_,"Num:Spam") then
Num_Msg_Max = DevAli:hget(ReLaX.."Ali:Spam:Group:User"..msg.chat_id_,"Num:Spam") 
end
if DevAli:hget(ReLaX.."Ali:Spam:Group:User"..msg.chat_id_,"Num:Spam:Time") then
Time_Spam = DevAli:hget(ReLaX.."Ali:Spam:Group:User"..msg.chat_id_,"Num:Spam:Time") 
end 
end
end 
--     Source ReLaX     --
...
if Constructor(msg) or tonumber(msg.sender_user_id_) == tonumber(ReLaX) then
DevAli:set(ReLaX..'Ali:PinnedMsg'..msg.chat_id_,msg.content_.message_id_)
else
local pin_id = DevAli:get(ReLaX..'Ali:PinnedMsg'..msg.chat_id_)
if pin_id and DevAli:get(ReLaX..'Ali:Lock:Pin'..msg.chat_id_) then
pinmsg(msg.chat_id_,pin_id,0)
end
end
end
if DevAli:get(ReLaX..'Ali:viewget'..msg.sender_user_id_) then
if not msg.forward_info_ then
DevAli:del(ReLaX..'Ali:viewget'..msg.sender_user_id_)
else
...
if DevAli:get(ReLaX..'Ali:Lock:Forwards'..msg.chat_id_) then
if msg.forward_info_.ID == "MessageForwardedFromUser" or msg.forward_info_.ID == "MessageForwardedPost" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
end
if DevAli:get(ReLaX..'Ali:Lock:Photo'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
if DevAli:get(ReLaX..'Ali:Lock:Links'..msg.chat_id_) then
if msg.content_.caption_:match("[Tt][Ee][Ll][Ee][Gg][Rr][Aa][Mm].[Mm][Ee]") or msg.content_.caption_:match("[Tt][Ll][Gg][Rr][Mm].[Mm][Ee]") or msg.content_.caption_:match("[Tt].[Mm][Ee]") or msg.content_.caption_:match("[Tt][Ee][Ll][Ee][Gg][Rr][Aa][Mm].[Dd][Oo][Gg]") then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
if DevAli:get(ReLaX..'Ali:Lock:Tags'..msg.chat_id_) then
if msg.content_.caption_:match("@") then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
if msg.content_.caption_:match("#") then
if DevAli:get(ReLaX..'Ali:Lock:Hashtak'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
if msg.content_.caption_:match("[Hh][Tt][Tt][Pp][Ss]://") or msg.content_.caption_:match("[Hh][Tt][Tt][Pp]://") or msg.content_.caption_:match(".[Ii][Rr]") or msg.content_.caption_:match(".[Cc][Oo][Mm]") or msg.content_.caption_:match(".[Oo][Rr][Gg]") or msg.content_.caption_:match(".[Ii][Nn][Ff][Oo]") or msg.content_.caption_:match("[Ww][Ww][Ww].") or msg.content_.caption_:match(".[Xx][Yy][Zz]") or msg.content_.caption_:match(".[Tt][Kk]") or msg.content_.ID == "MessageEntityTextUrl" or msg.content_.ID == "MessageEntityUrl" then
if DevAli:get(ReLaX..'Ali:Lock:WebLinks'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
if msg.content_.caption_:match("[\216-\219][\128-\191]") then
if DevAli:get(ReLaX..'Ali:Lock:Arabic'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
if msg.content_.caption_:match("[A-Z]") or msg.content_.caption_:match("[a-z]") then
if DevAli:get(ReLaX..'Ali:Lock:English'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
end
...
if DevAli:get(ReLaX..'Ali:Lock:Markdown'..msg.chat_id_) then
if not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
...
if DevAli:get(ReLaX..'Ali:Lock:Document'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
...
if not VipMem(msg) then
if DevAli:get(ReLaX..'Ali:Lock:Inline'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
--     Source ReLaX     --
...
elseif msg.content_.ID == "MessageSticker" then
if not VipMem(msg) then
if DevAli:get(ReLaX..'Ali:Lock:Stickers'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
...
if not DevAli:get(ReLaX..'Ali:Lock:BotWelcome') then 
tdcli_function ({ID = "GetUserProfilePhotos",user_id_ = ReLaX,offset_ = 0,limit_ = 1},function(extra,ALLII,success) 
...
local AliPhoto = (DevAli:get(ReLaX.."Ali:Photo:BotWelcome") or ALLII.photos_[0].sizes_[1].photo_.persistent_id_)
if DevAli:get(ReLaX.."Ali:Photo:BotWelcome") or ALLII.photos_[0] then
...
if DevAli:get(ReLaX..'Ali:Lock:Contact'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
--     Source ReLaX     --
...
if DevAli:get(ReLaX..'Ali:Lock:Music'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
...
if DevAli:get(ReLaX..'Ali:Lock:Voice'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
...
if DevAli:get(ReLaX..'Ali:Lock:Location'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
return
end
if msg.content_.caption_ then
...
if DevAli:get(ReLaX..'Ali:Lock:Videos'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
...
if DevAli:get(ReLaX..'Ali:Lock:Gifs'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
...
if DevAli:get(ReLaX..'Ali:Lock:Text'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
...
if not DevAli:get(ReLaX..'Ali:Spam:Text'..msg.chat_id_) then
sens = 400
else
sens = tonumber(DevAli:get(ReLaX..'Ali:Spam:Text'..msg.chat_id_))
end
if DevAli:get(ReLaX..'Ali:Lock:Spam'..msg.chat_id_) and string.len(msg.content_.text_) > (sens) or ctrl_chars > (sens) or real_digits > (sens) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
...
if not DevAli:get(ReLaX.."Ali:Lock:Fshar"..msg.chat_id_) and not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
...
if DevAli:get(ReLaX.."Ali:Lock:Farsi"..msg.chat_id_) and not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
ReplyStatus(msg,msg.sender_user_id_,"WrongWay","⌁︙ممنوع التكلم بالغه الفارسيه هنا")  
end end
if text and (text:match("ڬ") or text:match("ٺ") or text:match("چ") or text:match("ڇ") or text:match("ڿ") or text:match("ڀ") or text:match("ڎ") or text:match("ݫ") or text:match("ژ") or text:match("ڟ") or text:match("ݜ") or text:match("ڸ") or text:match("پ") or text:match("۴") or text:match("مک") or text:match("زدن") or text:match("دخترا") or text:match("دیوث") or text:match("کلیپشن") or text:match("خوششون") or text:match("میدا") or text:match("که") or text:match("بدانیم") or text:match("باید") or text:match("زناشویی") or text:match("آموزش") or text:match("راحتی") or text:match("خسته") or text:match("بیام") or text:match("بپوشم") or text:match("كرمه")) then
if DevAli:get(ReLaX.."Ali:Lock:FarsiBan"..msg.chat_id_) and not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
ChatKick(msg.chat_id_, msg.sender_user_id_)
end end 
if text and (text:match("خره بالله") or text:match("خبربك") or text:match("كسدينربك") or text:match("خرب بالله") or text:match("خرب الله") or text:match("خره بربك") or text:match("الله الكواد") or text:match("خره بمحمد") or text:match("كسم الله") or text:match("كسم ربك") or text:match("كسربك") or text:match("كسختالله") or text:match("كسخت الله") or text:match("خره بدينك") or text:match("خرهبدينك") or text:match("كسالله") or text:match("خربالله")) then
if not DevAli:get(ReLaX.."Ali:Lock:Kfr"..msg.chat_id_) and not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
...
if not DevAli:get(ReLaX.."Ali:Lock:Taf"..msg.chat_id_) and not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
...
--     Source ReLaX     --
if DevAli:get(ReLaX.."SET:GAME"..msg.chat_id_) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 6 then
Dev_Ali( msg.chat_id_, msg.id_, 1,"⌁︙يوجد فقط ( 6 ) اختيارات\n⌁︙ارسل اختيارك مره اخرى", 1, "md")    
return false  end 
local GETNUM = DevAli:get(ReLaX.."GAMES"..msg.chat_id_)
if tonumber(NUM) == tonumber(GETNUM) then
DevAli:del(ReLaX.."SET:GAME"..msg.chat_id_)   
...
if DevAli:get(ReLaX..'DevAli4'..msg.sender_user_id_) then
if text and text:match("^الغاء$") then 
send(msg.chat_id_, msg.id_, "⌁︙تم الغاء الامر")
DevAli:del(ReLaX..'DevAli4'..msg.sender_user_id_)
return false  end 
DevAli:del(ReLaX..'DevAli4'..msg.sender_user_id_)
...
if DevAli:get(ReLaX..'Ali:NameBot'..msg.sender_user_id_) == 'msg' then
if text and text:match("^الغاء$") then 
DevAli:del(ReLaX..'Ali:NameBot'..msg.sender_user_id_)
Dev_Ali(msg.chat_id_, msg.id_, 1, '⌁︙تم الغاء الامر', 1, 'md')
return false 
end 
Dev_Ali(msg.chat_id_, msg.id_, 1, '⌁︙تم حفظ اسم البوت ', 1, 'html')
DevAli:del(ReLaX..'Ali:NameBot'..msg.sender_user_id_)
DevAli:set(ReLaX..'Ali:NameBot', text)
return false 
end
--     Source ReLaX     --
if text == "الرابط" then
...
if tonumber((DevAli:get(ReLaX..'Ali:GamesNumber'..msg.chat_id_..msg.sender_user_id_) or 0)) == 0 then
Dev_Ali(msg.chat_id_, msg.id_, 1,'⌁︙لم تربح اي نقطه\n⌁︙ارسل ↫ الالعاب للعب', 1, 'md')
else 
Dev_Ali(msg.chat_id_, msg.id_, 1,'⌁︙عدد النقاط التي ربحتها ↫ '..(DevAli:get(ReLaX..'Ali:GamesNumber'..msg.chat_id_..msg.sender_user_id_)), 1, 'md')
end
end
if text ==  'حذف رسائلي' and ChCheck(msg) or text ==  'مسح رسائلي' and ChCheck(msg) then DevAli:del(ReLaX..'Ali:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_) Dev_Ali(msg.chat_id_, msg.id_, 1, '⌁︙تم حذف جميع رسائلك', 1, 'md') end
if text ==  'حذف نقاطي' and ChCheck(msg) or text ==  'مسح نقاطي' and ChCheck(msg) then DevAli:del(ReLaX..'Ali:GamesNumber'..msg.chat_id_..msg.sender_user_id_) Dev_Ali(msg.chat_id_, msg.id_, 1, '⌁︙تم حذف جميع نقاطك', 1, 'md') end
--     Source ReLaX     --
...
DevAli:set(ReLaX..'Ali:GameNum'..msg.chat_id_,name)
DevAli:del(ReLaX..'Ali:Games:Ids'..msg.chat_id_)
...
name = string.gsub(name,'🎚','🎚')
name = string.gsub(name,'☎️','☎️')
ReLaXTEAM = '⌁︙اول واحد يدز هذا السمايل يربح ↫ '..name
Dev_Ali(msg.chat_id_, msg.id_, 1,ReLaXTEAM, 1, 'md')
return false
end end
if text == DevAli:get(ReLaX..'Ali:GameNum'..msg.chat_id_) and not DevAli:get(ReLaX..'Ali:Games:Ids'..msg.chat_id_) then
if not DevAli:get(ReLaX..'Ali:Games:Ids'..msg.chat_id_) then 
ReLaXTEAM = '⌁︙مبروك لقد ربحت في اللعبه \n⌁︙ارسل ↫ سمايلات للعب مره اخرى'
Dev_Ali(msg.chat_id_, msg.id_, 1,ReLaXTEAM, 1, 'md')
DevAli:incrby(ReLaX..'Ali:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
end
...
ReLaXTEAM = '⌁︙اول واحد يرتبها يربح ↫ '..name
Dev_Ali(msg.chat_id_, msg.id_, 1,ReLaXTEAM, 1, 'md')
return false
end end
if text == DevAli:get(ReLaX..'Ali:GameNum'..msg.chat_id_) and not DevAli:get(ReLaX..'Ali:Games:Ids'..msg.chat_id_) then
...
if not DevAli:get(ReLaX..'Ali:Lock:Games'..msg.chat_id_) then
Num = math.random(1,6)
DevAli:set(ReLaX.."GAMES"..msg.chat_id_,Num) 
TEST = [[
➀     ➁     ➂     ➃     ➄     ➅
↓     ↓     ↓     ↓     ↓     ↓
👊 ‹› 👊🏻 ‹› 👊🏼 ‹› 👊🏽 ‹› 👊🏾 ‹› 👊🏿
...
DevAli:setex(ReLaX.."SET:GAME"..msg.chat_id_, 100, true)  
return false  
end end
...
ReLaXTEAM = '⌁︙اول واحد يحلها يربح ↫ '..name
Dev_Ali(msg.chat_id_, msg.id_, 1,ReLaXTEAM, 1, 'md')
return false
end end
if text == DevAli:get(ReLaX..'Ali:GameNum'..msg.chat_id_) and not DevAli:get(ReLaX..'Ali:Games:Ids'..msg.chat_id_) then
...
name = DevAli2[math.random(#DevAli2)]
DevAli:set(ReLaX..'Ali:GameNum2'..msg.chat_id_,name)
DevAli:del(ReLaX..'Ali:Games:Ids'..msg.chat_id_)
...
ReLaXTEAM = '⌁︙ما معنى هذا السمايل :؟ ↫ '..name
Dev_Ali(msg.chat_id_, msg.id_, 1,ReLaXTEAM, 1, 'md')
return false
end end
if text == DevAli:get(ReLaX..'Ali:GameNum2'..msg.chat_id_) and not DevAli:get(ReLaX..'Ali:Games:Ids'..msg.chat_id_) then
if not DevAli:get(ReLaX..'Ali:Games:Ids'..msg.chat_id_) then 
...
name = DevAli2[math.random(#DevAli2)]
DevAli:set(ReLaX..'Ali:GameNum3'..msg.chat_id_,name)
DevAli:del(ReLaX..'Ali:Games:Ids'..msg.chat_id_)
...
ReLaXTEAM = '⌁︙ما هو عكس كلمة ↫ '..name
Dev_Ali(msg.chat_id_, msg.id_, 1,ReLaXTEAM, 1, 'md')
return false
end end
if text == DevAli:get(ReLaX..'Ali:GameNum3'..msg.chat_id_) and not DevAli:get(ReLaX..'Ali:Games:Ids'..msg.chat_id_) then
if not DevAli:get(ReLaX..'Ali:Games:Ids'..msg.chat_id_) then 
...
DevAli2 = {'😸','☠','🐼','🐇','🌑','🌚','⭐️','📥','⛈','🌥','⛄️','👨‍🔬','👨‍💻','👨‍🔧','👩‍🍳','🧚‍♀','🧚‍♂️','🧝‍♂','🙍‍♂','🧖‍♂','👬','👨‍👨‍👧','🕓','🕤','⌛️','📅','👩‍⚖️','👨‍🎨'};
name = DevAli2[math.random(#DevAli2)]
DevAli:set(ReLaX..'Ali:GameNum4'..msg.chat_id_,name)
DevAli:del(ReLaX..'Ali:Games:Ids'..msg.chat_id_)
name = string.gsub(name,'😸','😹😹😹😸😹😹😹😹')
name = string.gsub(name,'☠️','💀💀💀☠️💀💀💀💀')
name = string.gsub(name,'🐼','👻👻👻👻👻👻👻🐼')
...
name = string.gsub(name,'👩‍⚖️','👨‍⚖️👨‍⚖️👨‍⚖️👨‍⚖️👨‍⚖️👩‍⚖️👨‍⚖️👨‍⚖️')
name = string.gsub(name,'👨‍🎨','👩‍🎨👩‍🎨👨‍🎨👩‍🎨👩‍🎨👩‍🎨👩‍🎨👩‍🎨')
ReLaXTEAM = '⌁︙اول واحد يطلع المختلف يربح\n{'..name..'} '
Dev_Ali(msg.chat_id_, msg.id_, 1,ReLaXTEAM, 1, 'md')
return false
end end
if text == DevAli:get(ReLaX..'Ali:GameNum4'..msg.chat_id_) and not DevAli:get(ReLaX..'Ali:Games:Ids'..msg.chat_id_) then
if not DevAli:get(ReLaX..'Ali:Games:Ids'..msg.chat_id_) then 
...
name = DevAli2[math.random(#DevAli2)]
DevAli:set(ReLaX..'Ali:GameNum5'..msg.chat_id_,name)
DevAli:del(ReLaX..'Ali:Games:Ids'..msg.chat_id_)
...
ReLaXTEAM = '⌁︙اكمل المثال التالي ↫ ['..name..']'
Dev_Ali(msg.chat_id_, msg.id_, 1,ReLaXTEAM, 1, 'md')
return false
end end
if text == DevAli:get(ReLaX..'Ali:GameNum5'..msg.chat_id_) then
if not DevAli:get(ReLaX..'Ali:Games:Ids'..msg.chat_id_) then 
DevAli:incrby(ReLaX..'Ali:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
DevAli:del(ReLaX..'Ali:GameNum5'..msg.chat_id_)
...
name = DevAli2[math.random(#DevAli2)]
DevAli:set(ReLaX..'Ali:GameNum6'..msg.chat_id_,name)
DevAli:del(ReLaX..'Ali:Games:Ids'..msg.chat_id_)
...
ReLaXTEAM = '⌁︙اكمل المعادله التاليه ↫ ⤈\n{'..name..'} '
Dev_Ali(msg.chat_id_, msg.id_, 1,ReLaXTEAM, 1, 'md')
return false
end end
if text == DevAli:get(ReLaX..'Ali:GameNum6'..msg.chat_id_) then
if not DevAli:get(ReLaX..'Ali:Games:Ids'..msg.chat_id_) then 
DevAli:incrby(ReLaX..'Ali:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
DevAli:del(ReLaX..'Ali:GameNum6'..msg.chat_id_)
...
name = DevAli2[math.random(#DevAli2)]
DevAli:set(ReLaX..'Ali:GameNum7'..msg.chat_id_,name)
DevAli:del(ReLaX..'Ali:Games:Ids'..msg.chat_id_)
...
ReLaXTEAM = '⌁︙ما معنى كلمة ↫ '..name
Dev_Ali(msg.chat_id_, msg.id_, 1,ReLaXTEAM, 1, 'md')
return false
end end
if text == DevAli:get(ReLaX..'Ali:GameNum7'..msg.chat_id_) then
if not DevAli:get(ReLaX..'Ali:Games:Ids'..msg.chat_id_) then 
DevAli:incrby(ReLaX..'Ali:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
DevAli:del(ReLaX..'Ali:GameNum7'..msg.chat_id_)
...
name = DevAli2[math.random(#DevAli2)]
DevAli:set(ReLaX..'Ali:GameNum8'..msg.chat_id_,name)
DevAli:del(ReLaX..'Ali:Games:Ids'..msg.chat_id_)
...
if text == DevAli:get(ReLaX..'Ali:GameNum8'..msg.chat_id_) then
if not DevAli:get(ReLaX..'Ali:Games:Ids'..msg.chat_id_) then 
DevAli:incrby(ReLaX..'Ali:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
DevAli:del(ReLaX..'Ali:GameNum8'..msg.chat_id_)
...
SetNum = 'محاولتان فقط'
elseif tonumber(DevAli:get(ReLaX..'Set:Num'..msg.chat_id_..msg.sender_user_id_)) == 2 then
...
if text == 'روليت' then
if not DevAli:get(ReLaX..'Ali:Lock:Games'..msg.chat_id_) then
DevAli:del(ReLaX.."Ali:NumRolet"..msg.chat_id_..msg.sender_user_id_) 
DevAli:del(ReLaX..'Ali:ListRolet'..msg.chat_id_)  
DevAli:setex(ReLaX.."Ali:StartRolet"..msg.chat_id_..msg.sender_user_id_,3600,true)  
Dev_Ali(msg.chat_id_, msg.id_, 1, '⌁︙حسنا لنلعب , ارسل عدد اللاعبين للروليت .', 1, 'md')
return false  
end
end
if text and text:match("^(%d+)$") and DevAli:get(ReLaX.."Ali:StartRolet"..msg.chat_id_..msg.sender_user_id_) then
if text == "1" then
Text = "⌁︙لا استطيع بدء اللعبه بلاعب واحد فقط"
else
DevAli:set(ReLaX.."Ali:NumRolet"..msg.chat_id_..msg.sender_user_id_,text)  
Text = '⌁︙تم بدء تسجيل اللسته يرجى ارسال المعرفات \n⌁︙الفائز يحصل على 5 نقاط عدد المطلوبين ↫ '..text..' لاعب'
end
DevAli:del(ReLaX.."Ali:StartRolet"..msg.chat_id_..msg.sender_user_id_)
send(msg.chat_id_,msg.id_,Text)
return false
end
if text and text:match('^(@[%a%d_]+)$') and DevAli:get(ReLaX.."Ali:NumRolet"..msg.chat_id_..msg.sender_user_id_) then 
if DevAli:sismember(ReLaX..'Ali:ListRolet'..msg.chat_id_,text) then
...
DevAli:sadd(ReLaX..'Ali:ListRolet'..msg.chat_id_,text)
local CountAdd = DevAli:get(ReLaX.."Ali:NumRolet"..msg.chat_id_..msg.sender_user_id_)
local CountAll = DevAli:scard(ReLaX..'Ali:ListRolet'..msg.chat_id_)
local CountUser = CountAdd - CountAll
if tonumber(CountAll) == tonumber(CountAdd) then 
DevAli:del(ReLaX.."Ali:NumRolet"..msg.chat_id_..msg.sender_user_id_) 
DevAli:setex(ReLaX.."Ali:WittingStartRolet"..msg.chat_id_..msg.sender_user_id_,1400,true) 
...
DevAli0 = (DevAli:get(ReLaX..'Ali:GamesNumber'..msg.chat_id_..msg.sender_user_id_) * 50)
DevAli:incrby(ReLaX..'Ali:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_,DevAli0)
Dev_Ali(msg.chat_id_, msg.id_, 1,'⌁︙تم بيع '..(DevAli:get(ReLaX..'Ali:GamesNumber'..msg.chat_id_..msg.sender_user_id_))..' من نقاطك\n⌁︙كل نقطه تساوي 50 رساله', 'md')
DevAli:del(ReLaX..'Ali:GamesNumber'..msg.chat_id_..msg.sender_user_id_)
end
end
--     Source ReLaX     --
if text == 'رفع المشرفين' and ChCheck(msg) or text == 'رفع الادمنيه' and ChCheck(msg) then  
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 200},function(arg,ALLII) 
DevAli:del(ReLaX..'Ali:AliConstructor:'..msg.chat_id_)
local num = 0
local admins = ALLII.members_  
for i=0 , #admins do   
...
DevAli:sadd(ReLaX..'Ali:BasicConstructor:'..msg.chat_id_,Manager_id)  
DevAli:sadd(ReLaX..'Ali:AliConstructor:'..msg.chat_id_,Manager_id)   
end  
end  
if num == 0 then
...
if DevAli:get(ReLaX.."Ali:Left:Bot"..ReLaX) and not SecondSudo(msg) then
...
local msguser = tonumber(DevAli:get(ReLaX..'Ali:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_))
local user_msgs = DevAli:get(ReLaX..'Ali:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
local cont = (tonumber(DevAli:get(ReLaX..'Ali:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_)) or 0)
local user_nkt = tonumber(DevAli:get(ReLaX..'Ali:GamesNumber'..msg.chat_id_..msg.sender_user_id_) or 0)
if result.username_ then username = '@'..result.username_ else username = 'لا يوجد' end
...
local GpList = DevAli:smembers(ReLaX.."Ali:Groups")
for k,v in pairs(GpList) do
tdcli_function({ID="ForwardMessages", chat_id_ = v, from_chat_id_ = msg.chat_id_, message_ids_ = {[0] = result.id_}, disable_notification_ = 0, from_background_ = 1},function(a,t) end,nil) 
end
local PvList = DevAli:smembers(ReLaX.."Ali:Users")
for k,v in pairs(PvList) do
tdcli_function({ID="ForwardMessages", chat_id_ = v, from_chat_id_ = msg.chat_id_, message_ids_ = {[0] = result.id_}, disable_notification_ = 0, from_background_ = 1},function(a,t) end,nil) 
end
Dev_Ali(msg.chat_id_, msg.id_, 1, '⌁︙تم اذاعة رسالتك بالتوجيه \n⌁︙‏في ↫ ❨ '..#GpList..' ❩ مجموعه \n⌁︙والى ↫ ❨ '..#PvList..' ❩ مشترك \n ✓', 1, 'md')
end
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),ReLaXTEAM)
end
end
--     Source ReLaX     --
if text == "مشاهده المنشور" and ChCheck(msg) or text == "مشاهدات المنشور" and ChCheck(msg) or text == "عدد المشاهدات" and ChCheck(msg) then
DevAli:set(ReLaX..'Ali:viewget'..msg.sender_user_id_,true)
...
if DevAli:get(ReLaX.."Ali:Kick:Me"..msg.chat_id_) then
...
DevAli:set(ReLaX.."Ali:Kick:Me"..msg.chat_id_, true)
local ReLaXTEAM = '⌁︙اهلا عزيزي ↫ '..AliRank(msg)..' \n⌁︙تم تعطيل امر اطردني'
Alimoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ReLaXTEAM, 14, string.len(msg.sender_user_id_))
end
if text == 'تفعيل اطردني' and Manager(msg) and ChCheck(msg) then
DevAli:del(ReLaX.."Ali:Kick:Me"..msg.chat_id_)
local ReLaXTEAM = '⌁︙اهلا عزيزي ↫ '..AliRank(msg)..' \n⌁︙تم تفعيل امر اطردني'
Alimoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ReLaXTEAM, 14, string.len(msg.sender_user_id_))
end
--     Source ReLaX     --
if text == "نزلني" and ChCheck(msg) then
if DevAli:get(ReLaX.."Ali:Del:Me"..msg.chat_id_) then
Dev_Ali(msg.chat_id_, msg.id_, 1, '⌁︙عذرا هذه الخاصيه معطله ', 1, 'md')
return false
end
...
DevAli:set(ReLaX.."Ali:Del:Me"..msg.chat_id_, true)
local ReLaXTEAM = '⌁︙اهلا عزيزي ↫ '..AliRank(msg)..' \n⌁︙تم تعطيل امر نزلني'
Alimoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ReLaXTEAM, 14, string.len(msg.sender_user_id_))
end
if text == 'تفعيل نزلني' and BasicConstructor(msg) and ChCheck(msg) then
DevAli:del(ReLaX.."Ali:Del:Me"..msg.chat_id_)
local ReLaXTEAM = '⌁︙اهلا عزيزي ↫ '..AliRank(msg)..' \n⌁︙تم تفعيل امر نزلني'
Alimoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ReLaXTEAM, 14, string.len(msg.sender_user_id_))
end
--     Source ReLaX     --
...
local EntryNumber = (DevAli:get(ReLaX..'Ali:EntryNumber'..msg.chat_id_..':'..os.date('%d')) or 0)
local ExitNumber = (DevAli:get(ReLaX..'Ali:ExitNumber'..msg.chat_id_..':'..os.date('%d')) or 0)
local MsgNumberDay = (DevAli:get(ReLaX..'Ali:MsgNumberDay'..msg.chat_id_..':'..os.date('%d')) or 0)
...
if text == "جهاتي" and ChCheck(msg) or text == "اضافاتي" and ChCheck(msg) then add = (tonumber(DevAli:get(ReLaX..'Ali:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_)) or 0) Dev_Ali(msg.chat_id_, msg.id_, 1, "⌁︙عدد جهاتك المضافه ↫ *❨ "..add.." ❩* ", 1, 'md') end
if text == "تعديلاتي" or text == "سحكاتي" and ChCheck(msg) then local edit_msg = DevAli:get(ReLaX..'Ali:EditMsg'..msg.chat_id_..msg.sender_user_id_) or 0  Dev_Ali(msg.chat_id_, msg.id_, 1, "⌁︙عدد تعديلاتك ↫ *❨ "..edit_msg.." ❩* ", 1, 'md') end
...
function ReLaXTEAM(extra,result,success)
if result.id_ then  
if tonumber(result.id_) == tonumber(ReLaX) then  
...
resolve_username(username,ReLaXTEAM)
end
end
--     Source ReLaX     --
...
if tonumber(result.sender_user_id_) == tonumber(ReLaX) then 
Dev_Ali(msg.chat_id_, msg.id_, 1, 'شو تمضرط اكو واحد يهين نفسه؟🤔👌🏿', 1, 'md') 
return false  
end  
...
if DevAli:sismember(ReLaX.."Ali:AliConstructor:"..msg.chat_id_,result.sender_user_id_) then
Dev_Ali(msg.chat_id_, msg.id_, 1, 'دي لكك تريد اهينن تاج راسكك؟😏🖕🏿', 1, 'md')
return false
end 
local ReLaXTEAM = "صارر ستاذيي 🏃🏻‍♂️♥️" 
...
if DevAli:sismember(ReLaX..'Ali:SecondSudo:',result.sender_user_id_) then
secondsudo = 'المطورين الثانويين • ' else secondsudo = '' end
if DevAli:sismember(ReLaX..'Ali:SudoBot:',result.sender_user_id_) then
sudobot = 'المطورين • ' else sudobot = '' end
if DevAli:sismember(ReLaX..'Ali:ManagerAll:',result.sender_user_id_) then
managerall = 'المدراء العامين • ' else managerall = '' end
if DevAli:sismember(ReLaX..'Ali:AdminAll:',result.sender_user_id_) then
adminall = 'الادمنيه العامين • ' else adminall = '' end
if DevAli:sismember(ReLaX..'Ali:VipAll:',result.sender_user_id_) then
vpall = 'المميزين العامين • ' else vpall = '' end
if DevAli:sismember(ReLaX..'Ali:BasicConstructor:'..msg.chat_id_, result.sender_user_id_) then
basicconstructor = 'المنشئين الاساسيين • ' else basicconstructor = '' end
if DevAli:sismember(ReLaX..'Ali:Constructor:'..msg.chat_id_, result.sender_user_id_) then
constructor = 'المنشئين • ' else constructor = '' end 
if DevAli:sismember(ReLaX..'Ali:Managers:'..msg.chat_id_, result.sender_user_id_) then
manager = 'المدراء • ' else manager = '' end
if DevAli:sismember(ReLaX..'Ali:Admins:'..msg.chat_id_, result.sender_user_id_) then
admins = 'الادمنيه • ' else admins = '' end
if DevAli:sismember(ReLaX..'Ali:VipMem:'..msg.chat_id_, result.sender_user_id_) then
vipmem = 'المميزين • ' else vipmem = '' end
if DevAli:sismember(ReLaX..'Ali:Cleaner:'..msg.chat_id_, result.sender_user_id_) then
...
if DevAli:sismember(ReLaX..'Ali:SecondSudo:',result.id_) then
secondsudo = 'المطورين الثانويين • ' else secondsudo = '' end
if DevAli:sismember(ReLaX..'Ali:SudoBot:',result.id_) then
sudobot = 'المطورين • ' else sudobot = '' end
if DevAli:sismember(ReLaX..'Ali:ManagerAll:',result.id_) then
managerall = 'المدراء العامين • ' else managerall = '' end
if DevAli:sismember(ReLaX..'Ali:AdminAll:',result.id_) then
adminall = 'الادمنيه العامين • ' else adminall = '' end
if DevAli:sismember(ReLaX..'Ali:VipAll:',result.id_) then
vpall = 'المميزين العامين • ' else vpall = '' end
if DevAli:sismember(ReLaX..'Ali:BasicConstructor:'..msg.chat_id_, result.id_) then
basicconstructor = 'المنشئين الاساسيين • ' else basicconstructor = '' end
if DevAli:sismember(ReLaX..'Ali:Constructor:'..msg.chat_id_, result.id_) then
constructor = 'المنشئين • ' else constructor = '' end 
if DevAli:sismember(ReLaX..'Ali:Managers:'..msg.chat_id_, result.id_) then
manager = 'المدراء • ' else manager = '' end
if DevAli:sismember(ReLaX..'Ali:Admins:'..msg.chat_id_, result.id_) then
admins = 'الادمنيه • ' else admins = '' end
if DevAli:sismember(ReLaX..'Ali:VipMem:'..msg.chat_id_, result.id_) then
vipmem = 'المميزين • ' else vipmem = '' end
if DevAli:sismember(ReLaX..'Ali:Cleaner:'..msg.chat_id_, result.id_) then
cleaner = 'المنظفين • ' else cleaner = ''
end
...
if AliDelAll(msg.sender_user_id_,msg.chat_id_) == 'sudoid' then
DevAli:srem(ReLaX..'Ali:SecondSudo:', result.id_)
DevAli:srem(ReLaX..'Ali:SudoBot:', result.id_)
DevAli:srem(ReLaX..'Ali:ManagerAll:', result.id_)
DevAli:srem(ReLaX..'Ali:AdminAll:', result.id_)
DevAli:srem(ReLaX..'Ali:VipAll:', result.id_)
DevAli:srem(ReLaX..'Ali:BasicConstructor:'..msg.chat_id_,result.id_)
DevAli:srem(ReLaX..'Ali:Constructor:'..msg.chat_id_,result.id_)
DevAli:srem(ReLaX..'Ali:Managers:'..msg.chat_id_, result.id_)
DevAli:srem(ReLaX..'Ali:Admins:'..msg.chat_id_, result.id_)
DevAli:srem(ReLaX..'Ali:VipMem:'..msg.chat_id_, result.id_)
DevAli:srem(ReLaX..'Ali:Cleaner:'..msg.chat_id_, result.id_)
elseif AliDelAll(msg.sender_user_id_,msg.chat_id_) == 'secondsudo' then
DevAli:srem(ReLaX..'Ali:SudoBot:', result.id_)
DevAli:srem(ReLaX..'Ali:ManagerAll:', result.id_)
DevAli:srem(ReLaX..'Ali:AdminAll:', result.id_)
...
if result.id_ then
DevAli:sadd(ReLaX..'Ali:SecondSudo:',result.id_)
...
DevAli:sadd(ReLaX..'Ali:SecondSudo:',user)
...
DevAli:srem(ReLaX..'Ali:SecondSudo:',user)
...
function promreply(extra,result,success)
if result.id_ then
DevAli:sadd(ReLaX..'Ali:SudoBot:',result.id_)
...
DevAli:sadd(ReLaX..'Ali:SudoBot:',user)
...
DevAli:srem(ReLaX..'Ali:SudoBot:',user)
...
function promreply(extra,result,success)
if result.id_ then
DevAli:sadd(ReLaX..'Ali:ManagerAll:',result.id_)
...
DevAli:sadd(ReLaX..'Ali:ManagerAll:',user)
...
DevAli:srem(ReLaX..'Ali:ManagerAll:',user)
...
function promreply(extra,result,success)
if result.id_ then
DevAli:sadd(ReLaX..'Ali:AdminAll:',result.id_)
...
DevAli:sadd(ReLaX..'Ali:AdminAll:',user)
...
DevAli:srem(ReLaX..'Ali:AdminAll:',user)
...
function promreply(extra,result,success)
if result.id_ then
DevAli:sadd(ReLaX..'Ali:VipAll:',result.id_)
...
DevAli:sadd(ReLaX..'Ali:VipAll:',user)
...
DevAli:srem(ReLaX..'Ali:VipAll:',user)
...
function promreply(extra,result,success)
if result.id_ then
DevAli:sadd(ReLaX..'Ali:BasicConstructor:'..msg.chat_id_,result.id_)
...
DevAli:sadd(ReLaX..'Ali:BasicConstructor:'..msg.chat_id_,user)
...
DevAli:srem(ReLaX..'Ali:BasicConstructor:'..msg.chat_id_,user)
...
function promreply(extra,result,success)
if result.id_ then
DevAli:sadd(ReLaX..'Ali:Constructor:'..msg.chat_id_,result.id_)
...
DevAli:sadd(ReLaX..'Ali:Constructor:'..msg.chat_id_,user)
...
DevAli:srem(ReLaX..'Ali:Constructor:'..msg.chat_id_,user)
...
DevAli:sadd(ReLaX..'Ali:Managers:'..msg.chat_id_,user)
...
DevAli:srem(ReLaX..'Ali:Managers:'..msg.chat_id_,user)
...
function promreply(extra,result,success)
if result.id_ then
DevAli:sadd(ReLaX..'Ali:Cleaner:'..msg.chat_id_,result.id_)
...
DevAli:sadd(ReLaX..'Ali:Cleaner:'..msg.chat_id_,user)
...
DevAli:srem(ReLaX..'Ali:Cleaner:'..msg.chat_id_,user)
...
function prom_reply(extra, result, success)
if not BasicConstructor(msg) and DevAli:get(ReLaX.."Ali:Lock:ProSet"..msg.chat_id_) then 
...
DevAli:sadd(ReLaX..'Ali:Admins:'..msg.chat_id_,user)
...
DevAli:srem(ReLaX..'Ali:Admins:'..msg.chat_id_,user)
...
DevAli:sadd(ReLaX..'Ali:VipMem:'..msg.chat_id_,user)
...
DevAli:srem(ReLaX..'Ali:VipMem:'..msg.chat_id_,user)
...
DevAli:del(ReLaX.."Ali:Lock:ProSet"..msg.chat_id_)
...
DevAli:set(ReLaX.."Ali:Lock:ProSet"..msg.chat_id_,"true")
...
if not Constructor(msg) and DevAli:get(ReLaX.."Ali:Lock:KickBan"..msg.chat_id_) then 
...
ChatKick(result.chat_id_, result.sender_user_id_)
DevAli:sadd(ReLaX..'Ali:Ban:'..msg.chat_id_, result.sender_user_id_)
...
ChatKick(msg.chat_id_, result.id_)
DevAli:sadd(ReLaX..'Ali:Ban:'..msg.chat_id_, result.id_)
...
ChatKick(msg.chat_id_, user)
DevAli:sadd(ReLaX..'Ali:Ban:'..msg.chat_id_, user)
...
DevAli:srem(ReLaX..'Ali:Ban:'..msg.chat_id_, result.sender_user_id_)
...
if result.id_ then
DevAli:srem(ReLaX..'Ali:Ban:'..msg.chat_id_, result.id_)
...
DevAli:srem(ReLaX..'Ali:Ban:'..msg.chat_id_, user)
...
if not Constructor(msg) and DevAli:get(ReLaX.."Ali:Lock:MuteTked"..msg.chat_id_) then 
...
if DevAli:sismember(ReLaX..'Ali:Muted:'..msg.chat_id_, result.sender_user_id_) then
ReplyStatus(msg,result.sender_user_id_,"Reply","⌁︙هو بالفعل مكتوم من المجموعه")  
else
DevAli:sadd(ReLaX..'Ali:Muted:'..msg.chat_id_, result.sender_user_id_)
...
if DevAli:sismember(ReLaX..'Ali:Muted:'..msg.chat_id_, result.id_) then
ReplyStatus(msg,result.id_,"Reply","⌁︙هو بالفعل مكتوم من المجموعه")  
else
DevAli:sadd(ReLaX..'Ali:Muted:'..msg.chat_id_, result.id_)
...
if DevAli:sismember(ReLaX..'Ali:Muted:'..msg.chat_id_, user) then
ReplyStatus(msg,user,"Reply","⌁︙هو بالفعل مكتوم من المجموعه")  
else
DevAli:sadd(ReLaX..'Ali:Muted:'..msg.chat_id_, user)
...
if not DevAli:sismember(ReLaX..'Ali:Muted:'..msg.chat_id_, result.sender_user_id_) then
ReplyStatus(msg,result.sender_user_id_,"Reply","⌁︙هو ليس مكتوم لالغاء كتمه")  
else
DevAli:srem(ReLaX..'Ali:Muted:'..msg.chat_id_, result.sender_user_id_)
...
if result.id_ then
if not DevAli:sismember(ReLaX..'Ali:Muted:'..msg.chat_id_, result.id_) then
ReplyStatus(msg,result.id_,"Reply","⌁︙هو ليس مكتوم لالغاء كتمه")  
else
DevAli:srem(ReLaX..'Ali:Muted:'..msg.chat_id_, result.id_)
...
if not DevAli:sismember(ReLaX..'Ali:Muted:'..msg.chat_id_, user) then
ReplyStatus(msg,user,"Reply","⌁︙هو ليس مكتوم لالغاء كتمه")  
else
DevAli:srem(ReLaX..'Ali:Muted:'..msg.chat_id_, user)
...
DevAli:sadd(ReLaX..'Ali:Tkeed:'..msg.chat_id_, result.sender_user_id_)
...
DevAli:sadd(ReLaX..'Ali:Tkeed:'..msg.chat_id_, result.id_)
...
DevAli:sadd(ReLaX..'Ali:Tkeed:'..msg.chat_id_, user)
...
DevAli:srem(ReLaX..'Ali:Tkeed:'..msg.chat_id_, result.id_)
...
DevAli:srem(ReLaX..'Ali:Tkeed:'..msg.chat_id_, user)
...
if result.id_ then
ChatKick(msg.chat_id_, result.id_)
DevAli:sadd(ReLaX..'Ali:BanAll:', result.id_)
...
if tonumber(user) == tonumber(ReLaX) then  
Dev_Ali(msg.chat_id_, msg.id_, 1, "⌁︙*لاتستطيع حظر البوت عام*", 1, 'md')
return false 
end
...
ChatKick(msg.chat_id_, user)
DevAli:sadd(ReLaX..'Ali:BanAll:', user)
...
if result.id_ then
DevAli:sadd(ReLaX..'Ali:MuteAll:', result.id_)
...
DevAli:srem(ReLaX..'Ali:BanAll:', result.sender_user_id_)
...
if result.id_ then
DevAli:srem(ReLaX..'Ali:BanAll:', result.id_)
DevAli:srem(ReLaX..'Ali:MuteAll:', result.id_)
...
DevAli:srem(ReLaX..'Ali:BanAll:', user)
DevAli:srem(ReLaX..'Ali:MuteAll:', user)
...
DevAli:setex(ReLaX.."Ali:EditDev"..msg.sender_user_id_,300,true)
end
if DevAli:get(ReLaX.."Ali:EditDev"..msg.sender_user_id_) then
if text and text:match("^الغاء$") then 
...
--     Source ReLaX     --
if msg.reply_to_message_id_ ~= 0 then
if text and text:match("^رفع مطي$") and not DevAli:get(ReLaX..'Ali:Lock:Stupid'..msg.chat_id_) and ChCheck(msg) then
function donky_by_reply(extra, result, success)
if DevAli:sismember(ReLaX..'User:Donky:'..msg.chat_id_, result.sender_user_id_) then
ReplyStatus(msg,result.sender_user_id_,"Reply","⌁︙هو مطي شرفع منه بعد😹💔") 
else
ReplyStatus(msg,result.sender_user_id_,"Reply","⌁︙تم رفعه في قائمة المطايه") 
DevAli:sadd(ReLaX..'User:Donky:'..msg.chat_id_, result.sender_user_id_)
end end
getMessage(msg.chat_id_, msg.reply_to_message_id_,donky_by_reply)
end end
--     Source ReLaX     --
if msg.reply_to_message_id_ ~= 0  then
if text and text:match("^تنزيل مطي$") and not DevAli:get(ReLaX..'Ali:Lock:Stupid'..msg.chat_id_) and ChCheck(msg) then
function donky_by_reply(extra, result, success)
if not DevAli:sismember(ReLaX..'User:Donky:'..msg.chat_id_, result.sender_user_id_) then
ReplyStatus(msg,result.sender_user_id_,"Reply","⌁︙هو ليس مطي ليتم تنزيله") 
else
DevAli:srem(ReLaX..'User:Donky:'..msg.chat_id_, result.sender_user_id_)
...
DevAli:del(ReLaX..'Ali:UsersMsgs'..msg.chat_id_..':'..result.sender_user_id_) 
DevAli:incrby(ReLaX..'Ali:UsersMsgs'..msg.chat_id_..':'..result.sender_user_id_,Num) 
...
function Reply(extra, result, success)
DevAli:incrby(ReLaX..'Ali:GamesNumber'..msg.chat_id_..result.sender_user_id_,Num) 
Dev_Ali(msg.chat_id_, msg.id_, 1, "⌁︙تم اضافة "..Num..' نقطه', 1, 'md') 
end
tdcli_function ({ID = "GetMessage",chat_id_=msg.chat_id_,message_id_=tonumber(msg.reply_to_message_id_)},Reply, nil)
return false
end
if DevAli:get(ReLaX..'Ali:Lock:Clean'..msg.chat_id_) then if msg.content_.video_ or msg.content_.document_ or msg.content_.sticker_ or msg.content_.photo_ or msg.content_.animation_ then if msg.reply_to_message_id_ ~= 0 then DevAli:sadd(ReLaX.."Ali:cleaner"..msg.chat_id_, msg.id_) else DevAli:sadd(ReLaX.."Ali:cleaner"..msg.chat_id_, msg.id_) end end end
if Manager(msg) and msg.reply_to_message_id_ ~= 0 then
if text and text:match("^تثبيت$") and ChCheck(msg) then 
if DevAli:sismember(ReLaX.."Ali:Lock:Pinpin",msg.chat_id_) and not BasicConstructor(msg) then
...
if data.ID == "Ok" then
DevAli:set(ReLaX..'Ali:PinnedMsg'..msg.chat_id_,msg.reply_to_message_id_)
...
local List = DevAli:smembers(ReLaX..'Ali:VipMem:'..msg.chat_id_)
text = "⌁︙قائمة المميزين ↫ ⤈ \n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉\n"
for k,v in pairs(List) do
...
local List = DevAli:smembers(ReLaX..Ali)
text = "⌁︙قائمة الادمنيه ↫ ⤈ \n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉\n"
for k,v in pairs(List) do
local username = DevAli:get(ReLaX..'Save:UserName'..v)
if username then
...
local List = DevAli:smembers(ReLaX..'Ali:Managers:'..msg.chat_id_)
text = "⌁︙قائمة المدراء ↫ ⤈ \n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉\n"
for k,v in pairs(List) do
local username = DevAli:get(ReLaX..'Save:UserName'..v)
if username then
...
local List = DevAli:smembers(ReLaX..'Ali:Constructor:'..msg.chat_id_)
text = "⌁︙قائمة المنشئين ↫ ⤈ \n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉\n"
for k,v in pairs(List) do
local username = DevAli:get(ReLaX..'Save:UserName'..v)
if username then
...
local List = DevAli:smembers(ReLaX..'Ali:Muted:'..msg.chat_id_)
...
local List = DevAli:smembers(ReLaX..'Ali:Tkeed:'..msg.chat_id_)
text = "⌁︙قائمة المقيدين ↫ ⤈ \n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉\n"
for k,v in pairs(List) do
local username = DevAli:get(ReLaX..'Save:UserName'..v)
if username then
...
local List = DevAli:smembers(ReLaX..'Ali:Ban:'..msg.chat_id_)
...
local List = DevAli:hkeys(ReLaX..'Ali:Filters:'..msg.chat_id_)
text = "⌁︙قائمة المنع ↫ ⤈ \n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉\n"
for k, v in pairs(List) do
text = text..k..'~ ❨ '..v..' ❩\n'
end
...
local List = DevAli:smembers(ReLaX..'User:Donky:'..msg.chat_id_)
...
local List = DevAli:smembers(ReLaX..'Ali:SecondSudo:')
...
local BanAll = DevAli:smembers(ReLaX..'Ali:BanAll:')
local MuteAll = DevAli:smembers(ReLaX..'Ali:MuteAll:')
if #BanAll ~= 0 then 
...
local List = DevAli:smembers(ReLaX..'Ali:SudoBot:')
text = "⌁︙قائمة المطورين ↫ ⤈ \n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉\n"
for k,v in pairs(List) do
...
local List = DevAli:smembers(ReLaX..'Ali:ManagerAll:')
...
local List = DevAli:smembers(ReLaX..'Ali:VipAll:')
...
if result.content_.sticker_ then
local idsticker = result.content_.sticker_.sticker_.persistent_id_
DevAli:srem(ReLaX.."Ali:FilterSteckr"..msg.chat_id_,idsticker)
Dev_Ali(msg.chat_id_, msg.id_, 1, '⌁︙تم الغاء منع الملصق يمكنهم ارساله الان', 1, 'md')
return false
end
if result.content_.ID == "MessagePhoto" then
local photo = result.content_.photo_.id_
DevAli:srem(ReLaX.."Ali:FilterPhoto"..msg.chat_id_,photo)
Dev_Ali(msg.chat_id_, msg.id_, 1, '⌁︙تم الغاء منع الصوره يمكنهم ارسالها الان', 1, 'md')
return false
end
if result.content_.animation_.animation_ then
local idanimation = result.content_.animation_.animation_.persistent_id_
DevAli:srem(ReLaX.."Ali:FilterAnimation"..msg.chat_id_,idanimation)
...
Alimoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ReLaXTEAM, 14, string.len(msg.sender_user_id_))
DevAli:del(ReLaX..'Ali:Thwel:Ali'..msg.chat_id_) 
end
if text and (text == "تعطيل تحويل الصيغ" or text == "تعطيل التحويل") and Manager(msg) and ChCheck(msg) then
local ReLaXTEAM = '⌁︙اهلا عزيزي ↫ '..AliRank(msg)..' \n⌁︙تم تعطيل تحويل الصيغ'
Alimoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ReLaXTEAM, 14, string.len(msg.sender_user_id_))
DevAli:set(ReLaX..'Ali:Thwel:Ali'..msg.chat_id_,true)  
end
if text == 'تحويل' and not DevAli:get(ReLaX..'Ali:Thwel:Ali'..msg.chat_id_) then  
if tonumber(msg.reply_to_message_id_) > 0 then 
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
local user_msgs = DevAli:get(ReLaX..'Ali:UsersMsgs'..msg.chat_id_..':'..data.id_) or 0
local user_nkt = tonumber(DevAli:get(ReLaX..'Ali:GamesNumber'..msg.chat_id_..data.id_) or 0)
if DevAli:sismember(ReLaX..'Ali:BanAll:',result.sender_user_id_) then
Tkeed = 'محظور عام'
elseif DevAli:sismember(ReLaX..'Ali:MuteAll:',result.sender_user_id_) then
Tkeed = 'مكتوم عام'
elseif DevAli:sismember(ReLaX..'Ali:Ban:'..msg.chat_id_,result.sender_user_id_) then
Tkeed = 'محظور'
elseif DevAli:sismember(ReLaX..'Ali:Muted:'..msg.chat_id_,result.sender_user_id_) then
Tkeed = 'مكتوم'
elseif DevAli:sismember(ReLaX..'Ali:Tkeed:'..msg.chat_id_,result.sender_user_id_) then
Tkeed = 'مقيد'
else
Tkeed = false
end
...
if DevAli:sismember(ReLaX..'Ali:SudoBot:',result.sender_user_id_) and SudoBot(msg) then
sudobot = '\n⌁︙عدد الكروبات ↫ '..(DevAli:get(ReLaX..'Ali:Sudos'..result.sender_user_id_) or 0)..'' 
else 
sudobot = '' 
end
...
local user_msgs = DevAli:get(ReLaX..'Ali:UsersMsgs'..msg.chat_id_..':'..res.id_) or 0
local user_nkt = tonumber(DevAli:get(ReLaX..'Ali:GamesNumber'..msg.chat_id_..res.id_) or 0)
if DevAli:sismember(ReLaX..'Ali:BanAll:',res.id_) then
Tkeed = 'محظور عام'
elseif DevAli:sismember(ReLaX..'Ali:MuteAll:',res.id_) then
Tkeed = 'مكتوم عام'
elseif DevAli:sismember(ReLaX..'Ali:Ban:'..msg.chat_id_,res.id_) then
Tkeed = 'محظور'
elseif DevAli:sismember(ReLaX..'Ali:Muted:'..msg.chat_id_,res.id_) then
Tkeed = 'مكتوم'
elseif DevAli:sismember(ReLaX..'Ali:Tkeed:'..msg.chat_id_,res.id_) then
Tkeed = 'مقيد'
else
Tkeed = false
end
...
if DevAli:sismember(ReLaX..'Ali:SudoBot:',res.id_) and SudoBot(msg) then
sudobot = '\n⌁︙عدد الكروبات ↫ '..(DevAli:get(ReLaX..'Ali:Sudos'..res.id_) or 0)..'' 
else 
sudobot = '' 
end
...
local user_msgs = DevAli:get(ReLaX..'Ali:UsersMsgs'..msg.chat_id_..':'..iduser) or 0
local user_nkt = tonumber(DevAli:get(ReLaX..'Ali:GamesNumber'..msg.chat_id_..iduser) or 0)
if DevAli:sismember(ReLaX..'Ali:BanAll:',iduser) then
Tkeed = 'محظور عام'
elseif DevAli:sismember(ReLaX..'Ali:MuteAll:',iduser) then
Tkeed = 'مكتوم عام'
elseif DevAli:sismember(ReLaX..'Ali:Ban:'..msg.chat_id_,iduser) then
Tkeed = 'محظور'
elseif DevAli:sismember(ReLaX..'Ali:Muted:'..msg.chat_id_,iduser) then
Tkeed = 'مكتوم'
elseif DevAli:sismember(ReLaX..'Ali:Tkeed:'..msg.chat_id_,iduser) then
Tkeed = 'مقيد'
else
Tkeed = false
end
...
if DevAli:sismember(ReLaX..'Ali:SudoBot:',iduser) and SudoBot(msg) then
sudobot = '\n⌁︙عدد الكروبات ↫ '..(DevAli:get(ReLaX..'Ali:Sudos'..iduser) or 0)..'' 
else 
sudobot = '' 
end
...
if DevAli:sismember(ReLaX..'Ali:Muted:'..msg.chat_id_,result.sender_user_id_) then muted = 'مكتوم' else muted = 'غير مكتوم' end
if DevAli:sismember(ReLaX..'Ali:Ban:'..msg.chat_id_,result.sender_user_id_) then banned = 'محظور' else banned = 'غير محظور' end
...
if result.id_ then
if DevAli:sismember(ReLaX..'Ali:Muted:'..msg.chat_id_,result.id_) then muted = 'مكتوم' else muted = 'غير مكتوم' end
if DevAli:sismember(ReLaX..'Ali:Ban:'..msg.chat_id_,result.id_) then banned = 'محظور' else banned = 'غير محظور' end
...
DevAli:set(ReLaX.."Ali:GpIds:Text"..msg.chat_id_,Text_Rand)
...
DevAli:set("ReLaX:New:id:"..ReLaX..msg.sender_user_id_,'ReLaXTEAM')
return "ReLaXTEAM"
end
if text and DevAli:get("ReLaX:New:id:"..ReLaX..msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_Ali(msg.chat_id_, msg.id_, 1, '⌁︙تم الغاء حفظ كليشة الايدي', 1, 'md')
DevAli:del("ReLaX:New:id:"..ReLaX..msg.sender_user_id_)
return false
end
DevAli:del("ReLaX:New:id:"..ReLaX..msg.sender_user_id_)
Dev_Ali(msg.chat_id_, msg.id_, 1, '⌁︙تم حفظ كليشة الايدي العامه', 1, 'md')
DevAli:set(ReLaX.."Ali:AllIds:Text",text)
return false
end
...
DevAli:del(ReLaX.."Ali:AllIds:Text")
end
end
--     Source ReLaX     --
if text and text:match("^تعيين الايدي$") and ChCheck(msg) or text and text:match("^تعين الايدي$") and ChCheck(msg) then
Dev_Ali(msg.chat_id_, msg.id_, 1, '⌁︙رجائا اتبع التعليمات للتعيين \n⌁︙لطبع كليشة الايدي ارسل كليشه تحتوي على النصوص التي باللغه الانجليزيه ادناه ↫ ⤈\n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉\n `#username` ↬ لطبع المعرف\n `#id` ↬ لطبع الايدي \n `#photos` ↬ لطبع عدد الصور \n `#stast` ↬ لطبع الرتب \n `#msgs` ↬ لطبع عدد الرسائل \n `#msgday` ↬ لطبع الرسائل اليوميه \n `#CustomTitle` ↬ لطبع اللقب \n `#bio` ↬ لطبع البايو \n `#auto` ↬ لطبع التفاعل \n `#game` ↬ لطبع عدد النقاط \n `#cont` ↬ لطبع عدد الجهات \n `#edit` ↬ لطبع عدد السحكات \n `#Description` ↬ لطبع تعليق الصور\n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉', 1, 'md')
DevAli:set("ReLaX:New:id:"..ReLaX..msg.chat_id_..msg.sender_user_id_,'ReLaXTEAM')
return "ReLaXTEAM"
end
if text and Manager(msg) and DevAli:get("ReLaX:New:id:"..ReLaX..msg.chat_id_..msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_Ali(msg.chat_id_, msg.id_, 1, '⌁︙تم الغاء حفظ كليشة الايدي', 1, 'md')
DevAli:del("ReLaX:New:id:"..ReLaX..msg.chat_id_..msg.sender_user_id_)
return false
end
DevAli:del("ReLaX:New:id:"..ReLaX..msg.chat_id_..msg.sender_user_id_)
Dev_Ali(msg.chat_id_, msg.id_, 1, '⌁︙تم حفظ الكليشه الجديده', 1, 'md')
DevAli:set(ReLaX.."Ali:GpIds:Text"..msg.chat_id_,text)
return false
end
if text and text:match("^حذف الايدي$") and ChCheck(msg) or text and text:match("^مسح الايدي$") and ChCheck(msg) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","⌁︙تم حذف كليشة الايدي")  
DevAli:del(ReLaX.."Ali:GpIds:Text"..msg.chat_id_)
end
end
--     Source ReLaX     --
if msg.reply_to_message_id_ ~= 0 then
...
function ReLaXTEAM(extra,ALLII,success)
if ALLII.username_ then username = '@'..ALLII.username_ else username = 'لا يوجد' end
...
local function getpro(extra, ALLII, success) 
local msgsday = DevAli:get(ReLaX..'Ali:UsersMsgs'..ReLaX..os.date('%d')..':'..msg.chat_id_..':'..msg.sender_user_id_) or 0
local edit_msg = DevAli:get(ReLaX..'Ali:EditMsg'..msg.chat_id_..msg.sender_user_id_) or 0
local user_msgs = DevAli:get(ReLaX..'Ali:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
local user_nkt = tonumber(DevAli:get(ReLaX..'Ali:GamesNumber'..msg.chat_id_..msg.sender_user_id_) or 0)
local cont = (tonumber(DevAli:get(ReLaX..'Ali:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_)) or 0)
...
if ALLII.photos_[0] then
if not DevAli:get(ReLaX..'Ali:Lock:Id'..msg.chat_id_) then 
if not DevAli:get(ReLaX..'Ali:Lock:Id:Photo'..msg.chat_id_) then 
if DevAli:get(ReLaX.."Ali:AllIds:Text") then
newpicid = DevAli:get(ReLaX.."Ali:AllIds:Text")
...
newpicid = newpicid:gsub('#photos',(ALLII.total_count_ or 'لا يوجد')) 
...
if not DevAli:get(ReLaX.."Ali:GpIds:Text"..msg.chat_id_) then 
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, ALLII.photos_[0].sizes_[1].photo_.persistent_id_,newpicid,msg.id_,msg.id_.."")
else 
local new_id = DevAli:get(ReLaX.."Ali:GpIds:Text"..msg.chat_id_)
...
local new_id = new_id:gsub('#photos',(ALLII.total_count_ or '')) 
...
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, ALLII.photos_[0].sizes_[1].photo_.persistent_id_,new_id,msg.id_,msg.id_.."")
end
else
if DevAli:get(ReLaX.."Ali:AllIds:Text") then
newallid = DevAli:get(ReLaX.."Ali:AllIds:Text")
...
newallid = newallid:gsub('#photos',(ALLII.total_count_ or 'لا يوجد')) 
...
local new_id = new_id:gsub('#CustomTitle',(CustomTitle or 'لا يوجد'))
local new_id = new_id:gsub('#bio',(GetBio(msg.sender_user_id_) or 'لا يوجد'))
local new_id = new_id:gsub('#photos',(ALLII.total_count_ or 'لا يوجد')) 
local new_id = new_id:gsub('#game',(user_nkt or 'لا يوجد'))
local new_id = new_id:gsub('#edit',(edit_msg or 'لا يوجد'))
local new_id = new_id:gsub('#cont',(cont or 'لا يوجد'))
local new_id = new_id:gsub('#msgs',(user_msgs or 'لا يوجد'))
...
if DevAli:get(ReLaX.."Ali:AllIds:Text") then
notpicid = DevAli:get(ReLaX.."Ali:AllIds:Text")
...
notpicid = notpicid:gsub('#photos',(ALLII.total_count_ or 'لا يوجد')) 
...
DevAli:set(ReLaX..'Ali:Lock:EditMsgs'..msg.chat_id_,true)
else
...
DevAli:set(ReLaX.."Ali:Lock:Bots"..msg.chat_id_,"ked")  
end
if LockText[2] == "التكرار" or LockText[2] == "التكرار بالحذف" then 
DevAli:hset(ReLaX.."Ali:Spam:Group:User"..msg.chat_id_ ,"Spam:User","del")  
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","⌁︙تم قفل التكرار بالحذف")  
end
if LockText[2] == "التكرار بالطرد" then 
DevAli:hset(ReLaX.."Ali:Spam:Group:User"..msg.chat_id_ ,"Spam:User","kick")  
...
DevAli:hset(ReLaX.."Ali:Spam:Group:User"..msg.chat_id_ ,"Spam:User","keed")  
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","⌁︙تم قفل التكرار بالتقيد")  
end
if LockText[2] == "التكرار بالكتم" then 
DevAli:hset(ReLaX.."Ali:Spam:Group:User"..msg.chat_id_ ,"Spam:User","mute")  
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","⌁︙تم قفل التكرار بالكتم")  
end
if BasicConstructor(msg) then
if LockText[2] == "التثبيت" then
if not DevAli:get(ReLaX..'Ali:Lock:Pin'..msg.chat_id_) then
tdcli_function ({ ID = "GetChannelFull",  channel_id_ = msg.chat_id_:gsub("-100","") }, function(arg,data)  DevAli:set(ReLaX.."Ali:PinnedMsg"..msg.chat_id_,data.pinned_message_id_)  end,nil)
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","⌁︙تم قفل التثبيت")  
DevAli:set(ReLaX..'Ali:Lock:Pin'..msg.chat_id_,true)
DevAli:sadd(ReLaX.."Ali:Lock:Pinpin",msg.chat_id_) 
else
...
DevAli:hset(ReLaX.."Ali:Spam:Group:User"..msg.chat_id_ ,"Num:Spam" ,TextSpam) 
end
end
if text and (text:match("^ضع زمن التكرار (%d+)$") or text:match("^وضع زمن التكرار (%d+)$")) then  
local TextSpam = text:match("ضع زمن التكرار (%d+)$") or text:match("وضع زمن التكرار (%d+)$")
DevAli:hset(ReLaX.."Ali:Spam:Group:User"..msg.chat_id_ ,"Num:Spam:Time" ,TextSpam) 
...
Alimoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ReLaXTEAM, 14, string.len(msg.sender_user_id_))
DevAli:del(ReLaX..'Ali:Lock:Id:Photo'..msg.chat_id_)
end end
if text and text == 'تعطيل الايدي بالصوره' and ChCheck(msg) then
if DevAli:get(ReLaX..'Ali:Lock:Id:Photo'..msg.chat_id_) then
Dev_Ali(msg.chat_id_, msg.id_, 1, '⌁︙الايدي بالصوره بالتاكيد معطل', 1, 'md')
else
local ReLaXTEAM = '⌁︙اهلا عزيزي ↫ '..AliRank(msg)..' \n⌁︙تم تعطيل الايدي بالصوره'
Alimoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ReLaXTEAM, 14, string.len(msg.sender_user_id_))
DevAli:set(ReLaX..'Ali:Lock:Id:Photo'..msg.chat_id_,true)
end end 
...
Alimoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ReLaXTEAM, 14, string.len(msg.sender_user_id_))
DevAli:del(ReLaX..'Ali:Lock:Id'..msg.chat_id_)
end end 
if text and text == 'تعطيل الايدي' and ChCheck(msg) then
if DevAli:get(ReLaX..'Ali:Lock:Id'..msg.chat_id_) then
Dev_Ali(msg.chat_id_, msg.id_, 1, '⌁︙الايدي بالتاكيد معطل ', 1, 'md')
else
local ReLaXTEAM = '⌁︙اهلا عزيزي ↫ '..AliRank(msg)..' \n⌁︙تم تعطيل الايدي بنجاح'
Alimoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ReLaXTEAM, 14, string.len(msg.sender_user_id_))
DevAli:set(ReLaX..'Ali:Lock:Id'..msg.chat_id_,true)
end end
end
--     Source ReLaX     --
...
local LinkGp = json:decode(https.request('https://api.telegram.org/bot'..TokenBot..'/exportChatInviteLink?chat_id='..msg.chat_id_))
if not DevAli:get(ReLaX.."Ali:Groups:Links"..msg.chat_id_)  then 
if LinkGp.ok == true then 
LinkGroup = LinkGp.result
DevAli:set(ReLaX.."Ali:Groups:Links"..msg.chat_id_,LinkGroup) 
...
Alimoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ReLaXTEAM, 14, string.len(msg.sender_user_id_))
DevAli:set(ReLaX.."Ali:Lock:Welcome"..msg.chat_id_,true)
end
if text and text:match("^تعطيل الترحيب$") and ChCheck(msg) then
local ReLaXTEAM = '⌁︙اهلا عزيزي ↫ '..AliRank(msg)..' \n⌁︙تم تعطيل الترحيب بنجاح'
Alimoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ReLaXTEAM, 14, string.len(msg.sender_user_id_))
DevAli:del(ReLaX.."Ali:Lock:Welcome"..msg.chat_id_)
end
if DevAli:get(ReLaX..'Ali:setwelcome'..msg.chat_id_..':'..msg.sender_user_id_) then 
if text == 'الغاء' then 
...
DevAli:set(ReLaX..'Ali:setwelcome'..msg.chat_id_..':'..msg.sender_user_id_,true)
end
...
--     Source ReLaX     --
if DevAli:get(ReLaX..'Ali:SetDescription'..msg.chat_id_..':'..msg.sender_user_id_) then  
if text == 'الغاء' then 
Dev_Ali(msg.chat_id_, msg.id_, 1, "⌁︙تم الغاء حفظ الوصف", 1, 'md')
DevAli:del(ReLaX..'Ali:SetDescription'..msg.chat_id_..':'..msg.sender_user_id_)
return false  
end 
DevAli:del(ReLaX..'Ali:SetDescription'..msg.chat_id_..':'..msg.sender_user_id_)
...
DevAli:set(ReLaX..'Ali:SetDescription'..msg.chat_id_..':'..msg.sender_user_id_,true)
...
DevAli:set(ReLaX.."Ali:SetFilters"..msg.sender_user_id_..msg.chat_id_,"add")  
return false  
end    
if DevAli:get(ReLaX.."Ali:SetFilters"..msg.sender_user_id_..msg.chat_id_) == "add" then
if text == 'الغاء' then 
Dev_Ali(msg.chat_id_, msg.id_, 1, '⌁︙تم الغاء امر المنع', 1, 'md')
DevAli:del(ReLaX.."Ali:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
return false  
end   
Dev_Ali(msg.chat_id_, msg.id_, 1, "⌁︙تم منع الكلمه ↫ "..text, 1, 'html')
DevAli:del(ReLaX.."Ali:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
DevAli:hset(ReLaX..'Ali:Filters:'..msg.chat_id_, text,'newword')
return false
end
if text and text == "الغاء منع" and msg.reply_to_message_id_ == 0 and ChCheck(msg) then       
Dev_Ali(msg.chat_id_, msg.id_, 1, "⌁︙ارسل لي الكلمه الان", 1, 'md') 
DevAli:set(ReLaX.."Ali:SetFilters"..msg.sender_user_id_..msg.chat_id_,"del")  
return false  
end    
if DevAli:get(ReLaX.."Ali:SetFilters"..msg.sender_user_id_..msg.chat_id_) == "del" then   
if text == 'الغاء' then 
Dev_Ali(msg.chat_id_, msg.id_, 1, '⌁︙تم الغاء امر الغاء المنع', 1, 'md')
DevAli:del(ReLaX.."Ali:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
return false  
end   
if not DevAli:hget(ReLaX..'Ali:Filters:'..msg.chat_id_, text) then  
Dev_Ali(msg.chat_id_, msg.id_, 1, "⌁︙الكلمه ↫ "..text.." غير ممنوعه", 1, 'html')
DevAli:del(ReLaX.."Ali:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
else
DevAli:hdel(ReLaX..'Ali:Filters:'..msg.chat_id_, text)
...
local gps = DevAli:scard(ReLaX.."Ali:Groups") local users = DevAli:scard(ReLaX.."Ali:Users") 
...
DevAli:setex(ReLaX..'Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
end 
end
...
DevAli:srem(ReLaX.."Ali:Users",pv[i])
sendok = sendok + 1
end
if #pv == i then 
if sendok == 0 then
...
local group = DevAli:smembers(ReLaX.."Ali:Groups")
local w = 0
local q = 0
for i = 1, #group do
...
DevAli:del(ReLaX..'Ali:Lock:EditMsgs'..msg.chat_id_)
else
...
DevAli:del(ReLaX.."Ali:Lock:Bots"..msg.chat_id_)  
end
if UnLockText[2] == "التكرار" then 
DevAli:hdel(ReLaX.."Ali:Spam:Group:User"..msg.chat_id_ ,"Spam:User")  
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","⌁︙تم فتح التكرار")  
end
if BasicConstructor(msg) then
if UnLockText[2] == "التثبيت" then
if DevAli:get(ReLaX..'Ali:Lock:Pin'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","⌁︙تم فتح التثبيت")  
DevAli:del(ReLaX..'Ali:Lock:Pin'..msg.chat_id_)
DevAli:srem(ReLaX.."Ali:Lock:Pinpin",msg.chat_id_)
else
...
DevAli:del(ReLaX..'Ali:Lock:Text'..msg.chat_id_)
else
...
DevAli:del(ReLaX..'Ali:Lock:Photo'..msg.chat_id_)
else
Dev_Ali(msg.chat_id_, msg.id_, 1, '⌁︙الصور بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
if UnLockText[2] == "الكلايش" then
if DevAli:get(ReLaX..'Ali:Lock:Spam'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","⌁︙تم فتح الكلايش")  
DevAli:del(ReLaX..'Ali:Lock:Spam'..msg.chat_id_)
else
...
DevAli:del(ReLaX..'Ali:Lock:Join'..msg.chat_id_)
else
...
DevAli:del(ReLaX..'Ali:Lock:Videos'..msg.chat_id_)
else
...
DevAli:del(ReLaX..'Ali:Lock:Document'..msg.chat_id_)
else
...
DevAli:del(ReLaX..'Ali:Lock:Inline'..msg.chat_id_)
else
...
DevAli:del(ReLaX..'Ali:Lock:Markdown'..msg.chat_id_)
else
...
DevAli:del(ReLaX..'Ali:Lock:Gifs'..msg.chat_id_)
else
...
DevAli:del(ReLaX..'Ali:Lock:Music'..msg.chat_id_)
else
...
DevAli:del(ReLaX..'Ali:Lock:Voice'..msg.chat_id_)
else
...
DevAli:del(ReLaX..'Ali:Lock:Links'..msg.chat_id_)
else
...
DevAli:del(ReLaX..'Ali:Lock:Location'..msg.chat_id_)
else
...
DevAli:del(ReLaX..'Ali:Lock:Tags'..msg.chat_id_)
else
...
DevAli:del(ReLaX..'Ali:Lock:Hashtak'..msg.chat_id_)
else
...
DevAli:del(ReLaX..'Ali:Lock:Contact'..msg.chat_id_)
else
...
DevAli:del(ReLaX..'Ali:Lock:WebLinks'..msg.chat_id_)
else
...
DevAli:del(ReLaX..'Ali:Lock:Arabic'..msg.chat_id_)
else
...
DevAli:del(ReLaX..'Ali:Lock:English'..msg.chat_id_)
else
...
DevAli:del(ReLaX..'Ali:Lock:TagServr'..msg.chat_id_)
else
...
DevAli:del(ReLaX..'Ali:Lock:Stickers'..msg.chat_id_)
else
...
DevAli:del(ReLaX..'Ali:Lock:Forwards'..msg.chat_id_)
else
...
DevAli:set(ReLaX.."Ali:Lock:Bots"..msg.chat_id_,"del") DevAli:hset(ReLaX.."Ali:Spam:Group:User"..msg.chat_id_ ,"Spam:User","keed") 
LockList ={'Ali:Lock:Links','Ali:Lock:Contact','Ali:Lock:Forwards','Ali:Lock:Videos','Ali:Lock:Gifs','Ali:Lock:EditMsgs','Ali:Lock:Stickers','Ali:Lock:Farsi','Ali:Lock:Spam','Ali:Lock:WebLinks','Ali:Lock:Photo'}
for i,Lock in pairs(LockList) do
DevAli:set(ReLaX..Lock..msg.chat_id_,true)
end
...
DevAli:del(ReLaX..'Ali:Lock:Fshar'..msg.chat_id_) DevAli:del(ReLaX..'Ali:Lock:Taf'..msg.chat_id_) DevAli:del(ReLaX..'Ali:Lock:Kfr'..msg.chat_id_) 
DevAli:set(ReLaX.."Ali:Lock:Bots"..msg.chat_id_,"del") DevAli:hset(ReLaX.."Ali:Spam:Group:User"..msg.chat_id_ ,"Spam:User","keed") 
...
DevAli:set(ReLaX..'Ali:Spam:Text'..msg.chat_id_,SetSpam)
...
DevAli:del(ReLaX.."Ali:mem:Rd"..msg.chat_id_)
DevAli:del(ReLaX.."Ali:Cleaner:Rd"..msg.chat_id_)
DevAli:del(ReLaX.."Ali:VipMem:Rd"..msg.chat_id_)
DevAli:del(ReLaX.."Ali:Admins:Rd"..msg.chat_id_)
DevAli:del(ReLaX.."Ali:Managers:Rd"..msg.chat_id_)
DevAli:del(ReLaX.."Ali:Constructor:Rd"..msg.chat_id_)
DevAli:del(ReLaX.."Ali:BasicConstructor:Rd"..msg.chat_id_)
DevAli:del(ReLaX.."Ali:SudoBot:Rd"..msg.chat_id_)
end
end
--     Source ReLaX     --
...
if tonumber(admins[i].user_id_) ~= tonumber(ReLaX) then
...
DevAli:del(ReLaX..'Ali:BasicConstructor:'..msg.chat_id_)
end
end
if BasicConstructor(msg) then
if txts[2] == 'المنشئين' or txtss[2] == 'المنشئين' then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","⌁︙تم حذف المنشئين")  
DevAli:del(ReLaX..'Ali:Constructor:'..msg.chat_id_)
end end
if Constructor(msg) then
if txts[2] == 'المدراء' or txtss[2] == 'المدراء' then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","⌁︙تم حذف المدراء")  
DevAli:del(ReLaX..'Ali:Managers:'..msg.chat_id_)
end 
...
DevAli:del(ReLaX.."Ali:Groups:Links"..msg.chat_id_)
end
...
DevAli:del(ReLaX..'Ali:Muted:'..msg.chat_id_)
...
DevAli:srem(ReLaX..'Ali:Tkeed:'..msg.chat_id_, v)
end 
...
DevAli:del(ReLaX..'Ali:Filters:'..msg.chat_id_)
end
if txts[2] == 'قوائم المنع' or txtss[2] == 'قوائم المنع' then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","⌁︙تم حذف قوائم المنع")  
DevAli:del(ReLaX..'Ali:Filters:'..msg.chat_id_)
DevAli:del(ReLaX.."Ali:FilterAnimation"..msg.chat_id_)
DevAli:del(ReLaX.."Ali:FilterPhoto"..msg.chat_id_)
DevAli:del(ReLaX.."Ali:FilterSteckr"..msg.chat_id_)
end
...
DevAli:del(ReLaX..'Ali:Ban:'..msg.chat_id_) DevAli:del(ReLaX..'Ali:Admins:'..msg.chat_id_) DevAli:del(ReLaX..'User:Donky:'..msg.chat_id_) DevAli:del(ReLaX..'Ali:VipMem:'..msg.chat_id_) DevAli:del(ReLaX..'Ali:Filters:'..msg.chat_id_) DevAli:del(ReLaX..'Ali:Muted:'..msg.chat_id_)
...
local Managers = DevAli:smembers(ReLaX..'Ali:Managers:'..msg.chat_id_)
local admins = DevAli:smembers(ReLaX..'Ali:Admins:'..msg.chat_id_)
local vipmem = DevAli:smembers(ReLaX..'Ali:VipMem:'..msg.chat_id_)
local donky = DevAli:smembers(ReLaX..'User:Donky:'..msg.chat_id_)
...
spam_c = DevAli:get(ReLaX..'Ali:Spam:Text'..msg.chat_id_)
end
--     Source ReLaX     --
if DevAli:hget(ReLaX.."Ali:Spam:Group:User"..msg.chat_id_, "Spam:User") == "kick" then     
flood = "بالطرد"     
elseif DevAli:hget(ReLaX.."Ali:Spam:Group:User"..msg.chat_id_,"Spam:User") == "keed" then     
flood = "بالتقيد"     
elseif DevAli:hget(ReLaX.."Ali:Spam:Group:User"..msg.chat_id_,"Spam:User") == "mute" then     
flood = "بالكتم"           
elseif DevAli:hget(ReLaX.."Ali:Spam:Group:User"..msg.chat_id_,"Spam:User") == "del" then     
flood = "بالحذف"
else     
flood = "مفتوح"     
end
--     Source ReLaX     --
if DevAli:get(ReLaX.."Ali:Lock:Bots"..msg.chat_id_) == "del" then
lock_bots = "بالحذف"
elseif DevAli:get(ReLaX.."Ali:Lock:Bots"..msg.chat_id_) == "ked" then
lock_bots = "بالتقيد"   
elseif DevAli:get(ReLaX.."Ali:Lock:Bots"..msg.chat_id_) == "kick" then
lock_bots = "بالطرد"    
else
lock_bots = "مفتوحه"    
end
--     Source ReLaX     --
if DevAli:get(ReLaX..'Ali:Lock:Text'..msg.chat_id_) then mute_text = 'مقفله' else mute_text = 'مفتوحه'end
if DevAli:get(ReLaX..'Ali:Lock:Photo'..msg.chat_id_) then mute_photo = 'مقفله' else mute_photo = 'مفتوحه' end
if DevAli:get(ReLaX..'Ali:Lock:Videos'..msg.chat_id_) then mute_video = 'مقفله' else mute_video = 'مفتوحه' end
if DevAli:get(ReLaX..'Ali:Lock:Gifs'..msg.chat_id_) then mute_gifs = 'مقفله' else mute_gifs = 'مفتوحه' end
if DevAli:get(ReLaX..'Ali:Lock:Music'..msg.chat_id_) then mute_music = 'مقفله' else mute_music = 'مفتوحه' end
...
if DevAli:get(ReLaX..'Ali:Lock:TagServr'..msg.chat_id_) then lock_tgservice = 'مقفله' else lock_tgservice = 'مفتوحه' end
if DevAli:get(ReLaX..'Ali:Lock:WebLinks'..msg.chat_id_) then lock_wp = 'مقفله' else lock_wp = 'مفتوحه' end
if DevAli:get(ReLaX..'Ali:Lock:Hashtak'..msg.chat_id_) then lock_htag = 'مقفله' else lock_htag = 'مفتوحه' end
if DevAli:get(ReLaX..'Ali:Lock:Tags'..msg.chat_id_) then lock_tag = 'مقفله' else lock_tag = 'مفتوحه' end
if DevAli:get(ReLaX..'Ali:Lock:Location'..msg.chat_id_) then lock_location = 'مقفله' else lock_location = 'مفتوحه' end
if DevAli:get(ReLaX..'Ali:Lock:Contact'..msg.chat_id_) then lock_contact = 'مقفله' else lock_contact = 'مفتوحه' end
if DevAli:get(ReLaX..'Ali:Lock:English'..msg.chat_id_) then lock_english = 'مقفله' else lock_english = 'مفتوحه' end
if DevAli:get(ReLaX..'Ali:Lock:Arabic'..msg.chat_id_) then lock_arabic = 'مقفله' else lock_arabic = 'مفتوحه' end
if DevAli:get(ReLaX..'Ali:Lock:Forwards'..msg.chat_id_) then lock_forward = 'مقفله' else lock_forward = 'مفتوحه' end
if DevAli:get(ReLaX..'Ali:Lock:Document'..msg.chat_id_) then lock_file = 'مقفله' else lock_file = 'مفتوحه' end
if DevAli:get(ReLaX..'Ali:Lock:Markdown'..msg.chat_id_) then markdown = 'مقفله' else markdown = 'مفتوحه' end
if DevAli:get(ReLaX..'Ali:Lock:Spam'..msg.chat_id_) then lock_spam = 'مقفله' else lock_spam = 'مفتوحه' end
if DevAli:get(ReLaX..'Ali:Lock:Join'..msg.chat_id_) then lock_Join = 'مقفل' else lock_Join = 'مفتوح' end
if DevAli:get(ReLaX.."Ali:Lock:Welcome"..msg.chat_id_) then send_welcome = 'مقفله' else send_welcome = 'مفتوحه' end
if DevAli:get(ReLaX..'Ali:Lock:Fshar'..msg.chat_id_) then lock_fshar = 'مفتوح' else lock_fshar = 'مقفل' end
if DevAli:get(ReLaX..'Ali:Lock:Kfr'..msg.chat_id_) then lock_kaf = 'مفتوح' else lock_kaf = 'مقفل' end
if DevAli:get(ReLaX..'Ali:Lock:Taf'..msg.chat_id_) then lock_taf = 'مفتوحه' else lock_taf = 'مقفله' end
if DevAli:get(ReLaX..'Ali:Lock:Farsi'..msg.chat_id_) then lock_farsi = 'مقفله' else lock_farsi = 'مفتوحه' end
local Flood_Num = DevAli:hget(ReLaX.."Ali:Spam:Group:User"..msg.chat_id_,"Num:Spam") or 5
--     Source ReLaX     --
...
DevAli:del(ReLaX..'Ali:setrules'..msg.chat_id_..':'..msg.sender_user_id_)
return false  
end 
DevAli:del(ReLaX..'Ali:setrules'..msg.chat_id_..':'..msg.sender_user_id_)
DevAli:set(ReLaX..'Ali:rules'..msg.chat_id_,text)
...
DevAli:set(ReLaX..'Ali:setrules'..msg.chat_id_..':'..msg.sender_user_id_,true)
end
end
if text and text:match("^القوانين$") then
local rules = DevAli:get(ReLaX..'Ali:rules'..msg.chat_id_)
...
Alimoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ReLaXTEAM, 14, string.len(msg.sender_user_id_))
DevAli:del(ReLaX..'Ali:Zrf:Ali'..msg.chat_id_) 
end
...
UrlZrf = https.request('https://apiabs.ml/zrf.php?Ali='..URL.escape(text)) 
...
UrlZrf = https.request('https://apiabs.ml/zrf.php?Ali='..URL.escape(TextZrf)) 
Zrf = JSON.decode(UrlZrf) 
t = "⌁︙قائمة الزخرفه ↫ ⤈\n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉\n"
i = 0
for k,v in pairs(Zrf.ok) do
...
Alimoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ReLaXTEAM, 14, string.len(msg.sender_user_id_))
DevAli:del(ReLaX..'Ali:Brg:Ali'..msg.chat_id_) 
end
if text == "تعطيل الابراج" and Manager(msg) and ChCheck(msg) then
local ReLaXTEAM = '⌁︙اهلا عزيزي ↫ '..AliRank(msg)..' \n⌁︙تم تعطيل الابراج بنجاح'
Alimoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ReLaXTEAM, 14, string.len(msg.sender_user_id_))
DevAli:set(ReLaX..'Ali:Brg:Ali'..msg.chat_id_,true)  
end
...
Alimoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ReLaXTEAM, 14, string.len(msg.sender_user_id_))
DevAli:del(ReLaX..'Ali:Nsba:Ali'..msg.chat_id_) 
end
...
Alimoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ReLaXTEAM, 14, string.len(msg.sender_user_id_))
DevAli:set(ReLaX..'Ali:Nsba:Ali'..msg.chat_id_,true)  
end
if not DevAli:get(ReLaX..'Ali:Nsba:Ali'..msg.chat_id_) then
if text == "نسبه الحب" and ChCheck(msg) or text == "نسبة الحب" and ChCheck(msg) then
DevAli:set(ReLaX..'LoveNsba:Ali'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_Ali(msg.chat_id_, msg.id_, 1, '⌁︙قم بارسل اسمين لحساب نسبة الحب بينهما كمثال ↫ جاك وروز', 1, 'md')
end
end
if text and text ~= "نسبه الحب" and text ~= "نسبة الحب" and DevAli:get(ReLaX..'LoveNsba:Ali'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_Ali(msg.chat_id_, msg.id_, 1, '⌁︙تم الغاء امر نسبة الحب ', 1, 'md')
DevAli:del(ReLaX..'LoveNsba:Ali'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
...
DevAli:set(ReLaX..'HataNsba:Ali'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_Ali(msg.chat_id_, msg.id_, 1, '⌁︙قم بارسل اسمين لحساب نسبة الكره بينهما كمثال ↫ جاك وروز', 1, 'md')
end
end
if text and text ~= "نسبه الكره" and text ~= "نسبة الكره" and DevAli:get(ReLaX..'HataNsba:Ali'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_Ali(msg.chat_id_, msg.id_, 1, '⌁︙تم الغاء امر نسبة الكره ', 1, 'md')
DevAli:del(ReLaX..'HataNsba:Ali'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Ali = math.random(0,100);
...
DevAli:set(ReLaX..'RjolaNsba:Ali'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_Ali(msg.chat_id_, msg.id_, 1, '⌁︙قم بارسل اسم الشخص لقياس نسبة رجولته كمثال ↫ جاك', 1, 'md')
end
end
if text and text ~= "نسبه الرجوله" and text ~= "نسبة الرجوله" and text ~= "نسبه رجوله" and text ~= "نسبة رجوله" and DevAli:get(ReLaX..'RjolaNsba:Ali'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_Ali(msg.chat_id_, msg.id_, 1, '⌁︙تم الغاء امر نسبة الرجوله ', 1, 'md')
DevAli:del(ReLaX..'RjolaNsba:Ali'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Ali = math.random(0,100);
...
DevAli:set(ReLaX..'AnothaNsba:Ali'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_Ali(msg.chat_id_, msg.id_, 1, '⌁︙قم بارسل اسم الشخص لقياس نسبة انوثته كمثال ↫ روز', 1, 'md')
end
end
if text and text ~= "نسبه الانوثه" and text ~= "نسبة الانوثه" and text ~= "نسبه انوثه" and text ~= "نسبة انوثه" and DevAli:get(ReLaX..'AnothaNsba:Ali'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_Ali(msg.chat_id_, msg.id_, 1, '⌁︙تم الغاء امر نسبة الانوثه ', 1, 'md')
DevAli:del(ReLaX..'AnothaNsba:Ali'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Ali = math.random(0,100);
...
DevAli:set(ReLaX..'StupidNsba:Ali'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_Ali(msg.chat_id_, msg.id_, 1, '⌁︙قم بارسل اسم الشخص لقياس نسبة غبائه كمثال ↫ جاك او روز', 1, 'md')
end
end
if text and text ~= "نسبه الغباء" and text ~= "نسبة الغباء" and DevAli:get(ReLaX..'StupidNsba:Ali'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_Ali(msg.chat_id_, msg.id_, 1, '⌁︙تم الغاء امر نسبة الغباء ', 1, 'md')
DevAli:del(ReLaX..'StupidNsba:Ali'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Ali = math.random(0,100);
...
local ReLaXTEAM = '⌁︙اهلا عزيزي ↫ '..AliRank(msg)..' \n⌁︙تم تفعيل حساب العمر'
Alimoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ReLaXTEAM, 14, string.len(msg.sender_user_id_))
DevAli:del(ReLaX..'Ali:Age:Ali'..msg.chat_id_) 
end
if text == "تعطيل حساب العمر" and Manager(msg) and ChCheck(msg) then
local ReLaXTEAM = '⌁︙اهلا عزيزي ↫ '..AliRank(msg)..' \n⌁︙تم تعطيل حساب العمر'
Alimoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ReLaXTEAM, 14, string.len(msg.sender_user_id_))
DevAli:set(ReLaX..'Ali:Age:Ali'..msg.chat_id_,true)  
end
...
Alimoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ReLaXTEAM, 14, string.len(msg.sender_user_id_))
DevAli:del(ReLaX..'Ali:Mean:Ali'..msg.chat_id_) 
end
if text == "تعطيل معاني الاسماء" and Manager(msg) and ChCheck(msg) then
local ReLaXTEAM = '⌁︙اهلا عزيزي ↫ '..AliRank(msg)..' \n⌁︙تم تعطيل معاني الاسماء'
Alimoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ReLaXTEAM, 14, string.len(msg.sender_user_id_))
DevAli:set(ReLaX..'Ali:Mean:Ali'..msg.chat_id_,true)  
end
...
UrlMean = https.request('https://apiabs.ml/Mean.php?Ali='..URL.escape(TextMean)) 
...
--     Source ReLaX     --
if Admin(msg) then
if DevAli:get(ReLaX..'Ali:LockSettings'..msg.chat_id_) then 
if text == "الروابط" then if DevAli:get(ReLaX..'Ali:Lock:Links'..msg.chat_id_) then mute_links = 'مقفله' else mute_links = 'مفتوحه' end local ReLaXTEAM = "\n" .."⌁︙الروابط ↫ "..mute_links.."\n" Dev_Ali(msg.chat_id_, msg.id_, 1, ReLaXTEAM, 1, 'md') end
if text == "المعرف" or text == "المعرفات" then if DevAli:get(ReLaX..'Ali:Lock:Tags'..msg.chat_id_) then lock_tag = 'مقفوله' else lock_tag = 'مفتوحه' end local ReLaXTEAM = "\n" .."⌁︙المعرف ↫ "..lock_tag.."\n" Dev_Ali(msg.chat_id_, msg.id_, 1, ReLaXTEAM, 1, 'md') end
if text == "المتحركه" or text == "الملصقات المتحركه" then if DevAli:get(ReLaX..'Ali:Lock:Gifs'..msg.chat_id_) then mute_gifs = 'مقفوله' else mute_gifs = 'مفتوحه' end local ReLaXTEAM = "\n" .."⌁︙المتحركه ↫ "..mute_gifs.."\n" Dev_Ali(msg.chat_id_, msg.id_, 1, ReLaXTEAM, 1, 'md') end
if text == "الملصقات" then if DevAli:get(ReLaX..'Ali:Lock:Stickers'..msg.chat_id_) then lock_sticker = 'مقفوله' else lock_sticker = 'مفتوحه' end local ReLaXTEAM = "\n" .."⌁︙الملصقات ↫ "..lock_sticker.."\n" Dev_Ali(msg.chat_id_, msg.id_, 1, ReLaXTEAM, 1, 'md') end
if text == "الصور" then if DevAli:get(ReLaX..'Ali:Lock:Photo'..msg.chat_id_) then mute_photo = 'مقفوله' else mute_photo = 'مفتوحه' end local ReLaXTEAM = "\n" .."⌁︙الصور ↫ "..mute_photo.."\n" Dev_Ali(msg.chat_id_, msg.id_, 1, ReLaXTEAM, 1, 'md') end
if text == "الفيديو" or text == "الفيديوهات" then if DevAli:get(ReLaX..'Ali:Lock:Videos'..msg.chat_id_) then mute_video = 'مقفوله' else mute_video = 'مفتوحه' end local ReLaXTEAM = "\n" .."⌁︙الفيديو ↫ "..mute_video.."\n" Dev_Ali(msg.chat_id_, msg.id_, 1, ReLaXTEAM, 1, 'md') end
if text == "الاونلاين" then if DevAli:get(ReLaX..'Ali:Lock:Inline'..msg.chat_id_) then mute_in = 'مقفل' else mute_in = 'مفتوح' end local ReLaXTEAM = "\n" .."⌁︙الاونلاين ↫ "..mute_in.."\n" Dev_Ali(msg.chat_id_, msg.id_, 1, ReLaXTEAM, 1, 'md') end
if text == "الدردشه" then if DevAli:get(ReLaX..'Ali:Lock:Text'..msg.chat_id_) then mute_text = 'مقفله' else mute_text = 'مفتوحه' end local ReLaXTEAM = "\n" .."⌁︙الدردشه ↫ "..mute_text.."\n" Dev_Ali(msg.chat_id_, msg.id_, 1, ReLaXTEAM, 1, 'md') end
if text == "التوجيه" or text == "اعاده التوجيه" then if DevAli:get(ReLaX..'Ali:Lock:Forwards'..msg.chat_id_) then lock_forward = 'مقفل' else lock_forward = 'مفتوح' end local ReLaXTEAM = "\n" .."⌁︙التوجيه ↫ "..lock_forward.."\n" Dev_Ali(msg.chat_id_, msg.id_, 1, ReLaXTEAM, 1, 'md') end
if text == "الاغاني" then if DevAli:get(ReLaX..'Ali:Lock:Music'..msg.chat_id_) then mute_music = 'مقفوله' else mute_music = 'مفتوحه' end local ReLaXTEAM = "\n" .."⌁︙الاغاني ↫ "..mute_music.."\n" Dev_Ali(msg.chat_id_, msg.id_, 1, ReLaXTEAM, 1, 'md') end
if text == "الصوت" or text == "الصوتيات" then if DevAli:get(ReLaX..'Ali:Lock:Voice'..msg.chat_id_) then mute_voice = 'مقفول' else mute_voice = 'مفتوح' end local ReLaXTEAM = "\n" .."⌁︙الصوت ↫ "..mute_voice.."\n" Dev_Ali(msg.chat_id_, msg.id_, 1, ReLaXTEAM, 1, 'md') end
if text == "الجهات" or text == "جهات الاتصال" then if DevAli:get(ReLaX..'Ali:Lock:Contact'..msg.chat_id_) then lock_contact = 'مقفوله' else lock_contact = 'مفتوحه' end local ReLaXTEAM = "\n" .."⌁︙الجهات ↫ "..lock_contact.."\n" Dev_Ali(msg.chat_id_, msg.id_, 1, ReLaXTEAM, 1, 'md') end
if text == "الماركداون" then if DevAli:get(ReLaX..'Ali:Lock:Markdown'..msg.chat_id_) then markdown = 'مقفل' else markdown = 'مفتوح' end local ReLaXTEAM = "\n" .."⌁︙الماركداون ↫ "..markdown.."\n" Dev_Ali(msg.chat_id_, msg.id_, 1, ReLaXTEAM, 1, 'md') end
if text == "الهاشتاك" then if DevAli:get(ReLaX..'Ali:Lock:Hashtak'..msg.chat_id_) then lock_htag = 'مقفل' else lock_htag = 'مفتوح' end local ReLaXTEAM = "\n" .."⌁︙الهاشتاك ↫ "..lock_htag.."\n"Dev_Ali(msg.chat_id_, msg.id_, 1, ReLaXTEAM, 1, 'md') end
if text == "التعديل" then if DevAli:get(ReLaX..'Ali:Lock:EditMsgs'..msg.chat_id_) then mute_edit = 'مقفل' else mute_edit = 'مفتوح' end local ReLaXTEAM = "\n" .."⌁︙التعديل ↫ "..mute_edit.."\n" Dev_Ali(msg.chat_id_, msg.id_, 1, ReLaXTEAM, 1, 'md') end
if text == "التثبيت" then if DevAli:get(ReLaX..'Ali:Lock:Pin'..msg.chat_id_) then lock_pin = 'مقفل' else lock_pin = 'مفتوح' end local ReLaXTEAM = "\n" .."⌁︙التثبيت ↫ "..lock_pin.."\n" Dev_Ali(msg.chat_id_, msg.id_, 1, ReLaXTEAM, 1, 'md') end
if text == "الاشعارات" then if DevAli:get(ReLaX..'Ali:Lock:TagServr'..msg.chat_id_) then lock_tgservice = 'مقفوله' else lock_tgservice = 'مفتوحه' end local ReLaXTEAM = "\n" .."⌁︙الاشعارات ↫ "..lock_tgservice.."\n" Dev_Ali(msg.chat_id_, msg.id_, 1, ReLaXTEAM, 1, 'md') end
if text == "الكلايش" then if DevAli:get(ReLaX..'Ali:Lock:Spam'..msg.chat_id_) then lock_spam = 'مقفوله' else lock_spam = 'مفتوحه' end local ReLaXTEAM = "\n" .."⌁︙الكلايش ↫ "..lock_spam.."\n" Dev_Ali(msg.chat_id_, msg.id_, 1, ReLaXTEAM, 1, 'md') end
if text == "الدخول" then if DevAli:get(ReLaX..'Ali:Lock:Join'..msg.chat_id_) then lock_Join = 'مقفول' else lock_Join = 'مفتوح' end local ReLaXTEAM = "\n" .."⌁︙الدخول ↫ "..lock_Join.."\n" Dev_Ali(msg.chat_id_, msg.id_, 1, ReLaXTEAM, 1, 'md') end
if text == "الشبكات" then if DevAli:get(ReLaX..'Ali:Lock:WebLinks'..msg.chat_id_) then lock_wp = 'مقفوله' else lock_wp = 'مفتوحه' end local ReLaXTEAM = "\n" .."⌁︙الشبكات ↫ "..lock_wp.."\n" Dev_Ali(msg.chat_id_, msg.id_, 1, ReLaXTEAM, 1, 'md') end
if text == "المواقع" then if DevAli:get(ReLaX..'Ali:Lock:Location'..msg.chat_id_) then lock_location = 'مقفوله' else lock_location = 'مفتوحه' end local ReLaXTEAM = "\n" .."⌁︙المواقع ↫ "..lock_location.."\n" Dev_Ali(msg.chat_id_, msg.id_, 1, ReLaXTEAM, 1, 'md') end
if text == "العربيه" then if DevAli:get(ReLaX..'Ali:Lock:Arabic'..msg.chat_id_) then lock_arabic = 'مقفوله' else lock_arabic = 'مفتوحه' end local ReLaXTEAM = "\n" .."⌁︙العربيه ↫ "..lock_arabic.."\n" Dev_Ali(msg.chat_id_, msg.id_, 1, ReLaXTEAM, 1, 'md') end
if text == "الانكليزيه" then if DevAli:get(ReLaX..'Ali:Lock:English'..msg.chat_id_) then lock_english = 'مقفوله' else lock_english = 'مفتوحه' end local ReLaXTEAM = "\n" .."⌁︙الانكليزيه ↫ "..lock_english.."\n" Dev_Ali(msg.chat_id_, msg.id_, 1, ReLaXTEAM, 1, 'md') end
if text == "الكفر" then if DevAli:get(ReLaX..'Ali:Lock:Kfr'..msg.chat_id_) then lock_kaf = 'مفتوح' else lock_kaf = 'مقفل' end local ReLaXTEAM = "\n" .."⌁︙الكفر ↫ "..lock_kaf.."\n" Dev_Ali(msg.chat_id_, msg.id_, 1, ReLaXTEAM, 1, 'md') end
if text == "الفشار" then if DevAli:get(ReLaX..'Ali:Lock:Fshar'..msg.chat_id_) then lock_fshar = 'مفتوح' else lock_fshar = 'مقفل' end local ReLaXTEAM = "\n" .."⌁︙الفشار ↫ "..lock_fshar.."\n" Dev_Ali(msg.chat_id_, msg.id_, 1, ReLaXTEAM, 1, 'md') end
if text == "الطائفيه" then if DevAli:get(ReLaX..'Ali:Lock:Taf'..msg.chat_id_) then lock_taf = 'مفتوحه' else lock_taf = 'مقفله' end local ReLaXTEAM = "\n" .."⌁︙الطائفيه ↫ "..lock_taf.."\n" Dev_Ali(msg.chat_id_, msg.id_, 1, ReLaXTEAM, 1, 'md') end
end
--     Source ReLaX     --
if text == 'تفعيل كشف الاعدادات' and ChCheck(msg) then 
local ReLaXTEAM = '⌁︙اهلا عزيزي ↫ '..AliRank(msg)..' \n⌁︙تم تفعيل كشف الاعدادات'
Alimoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ReLaXTEAM, 14, string.len(msg.sender_user_id_))
DevAli:set(ReLaX..'Ali:LockSettings'..msg.chat_id_,true)  
end
if text == 'تعطيل كشف الاعدادات' and ChCheck(msg) then 
local ReLaXTEAM = '⌁︙اهلا عزيزي ↫ '..AliRank(msg)..' \n⌁︙تم تعطيل كشف الاعدادات'
Alimoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ReLaXTEAM, 14, string.len(msg.sender_user_id_))
DevAli:del(ReLaX..'Ali:LockSettings'..msg.chat_id_) 
end
--     Source ReLaX     --
if text == 'تفعيل اوامر التحشيش' and Manager(msg) and ChCheck(msg) then 
local ReLaXTEAM = '⌁︙اهلا عزيزي ↫ '..AliRank(msg)..' \n⌁︙تم تفعيل اوامر التحشيش'
Alimoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ReLaXTEAM, 14, string.len(msg.sender_user_id_))
DevAli:del(ReLaX..'Ali:Lock:Stupid'..msg.chat_id_)
end
...
Alimoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ReLaXTEAM, 14, string.len(msg.sender_user_id_))
DevAli:del(ReLaX..'Ali:Lock:GpRed'..msg.chat_id_)
end
if text == 'تعطيل ردود المدير' and Manager(msg) and ChCheck(msg) then 
local ReLaXTEAM = '⌁︙اهلا عزيزي ↫ '..AliRank(msg)..' \n⌁︙تم تعطيل ردود المدير'
Alimoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ReLaXTEAM, 14, string.len(msg.sender_user_id_))
DevAli:set(ReLaX..'Ali:Lock:GpRed'..msg.chat_id_,true)
end
--     Source ReLaX     --
if text == 'تفعيل ردود المطور' and Manager(msg) and ChCheck(msg) then 
local ReLaXTEAM = '⌁︙اهلا عزيزي ↫ '..AliRank(msg)..' \n⌁︙تم تفعيل ردود المطور'
Alimoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ReLaXTEAM, 14, string.len(msg.sender_user_id_))
DevAli:del(ReLaX..'Ali:Lock:AllRed'..msg.chat_id_)
end
if text == 'تعطيل ردود المطور' and Manager(msg) and ChCheck(msg) then 
local ReLaXTEAM = '⌁︙اهلا عزيزي ↫ '..AliRank(msg)..' \n⌁︙تم تعطيل ردود المطور'
Alimoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ReLaXTEAM, 14, string.len(msg.sender_user_id_))
DevAli:set(ReLaX..'Ali:Lock:AllRed'..msg.chat_id_,true)
end
--     Source ReLaX     --
if SecondSudo(msg) then
...
Alimoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ReLaXTEAM, 14, string.len(msg.sender_user_id_))
DevAli:del(ReLaX.."Ali:Left:Bot"..ReLaX)
end
if text == 'تعطيل المغادره' or text == '↫ تعطيل المغادره ⌁' then 
local ReLaXTEAM = '⌁︙اهلا عزيزي ↫ '..AliRank(msg)..' \n⌁︙تم تعطيل المغادره بنجاح'
Alimoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ReLaXTEAM, 14, string.len(msg.sender_user_id_))
DevAli:set(ReLaX.."Ali:Left:Bot"..ReLaX,true) 
end 
if text == 'تفعيل الاذاعه' or text == '↫ تفعيل الاذاعه ⌁' then 
local ReLaXTEAM = '⌁︙اهلا عزيزي ↫ '..AliRank(msg)..' \n⌁︙تم تفعيل الاذاعه بنجاح'
Alimoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ReLaXTEAM, 14, string.len(msg.sender_user_id_))
DevAli:del(ReLaX.."Ali:Send:Bot"..ReLaX)
end
if text == 'تعطيل الاذاعه' or text == '↫ تعطيل الاذاعه ⌁' then 
local ReLaXTEAM = '⌁︙اهلا عزيزي ↫ '..AliRank(msg)..' \n⌁︙تم تعطيل الاذاعه بنجاح'
Alimoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ReLaXTEAM, 14, string.len(msg.sender_user_id_))
DevAli:set(ReLaX.."Ali:Send:Bot"..ReLaX,true) 
end
end
--     Source ReLaX     --
...
--     Source ReLaX     --
if msg.content_.photo_ then
if DevAli:get(ReLaX..'Ali:SetPhoto'..msg.chat_id_..':'..msg.sender_user_id_) then
if msg.content_.photo_.sizes_[3] then
...
DevAli:del(ReLaX..'Ali:SetPhoto'..msg.chat_id_..':'..msg.sender_user_id_)
return false  end
if data.message_ == "CHAT_ADMIN_REQUIRED" then 
send(msg.chat_id_, msg.id_,"⌁︙ليست لدي صلاحية تغير معلومات المجموعه يرجى التحقق من الصلاحيات") 
DevAli:del(ReLaX..'Ali:SetPhoto'..msg.chat_id_..':'..msg.sender_user_id_)
...
DevAli:set(ReLaX..'Ali:SetPhoto'..msg.chat_id_..':'..msg.sender_user_id_,true)
end
--     Source ReLaX     --
...
if data.ID == "Ok" then
DevAli:del(ReLaX..'Ali:PinnedMsg'..msg.chat_id_)
...
DevAli:del(ReLaX..'Ali:Ban:'..msg.chat_id_)
else
local x = 0
...
local Muted = DevAli:scard(ReLaX.."Ali:Muted:"..msg.chat_id_) or "0"
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,dp) 
tdcli_function({ID="GetChannelFull",channel_id_ = msg.chat_id_:gsub("-100","")},function(arg,data) 
...
local ConstructorList = DevAli:scard(ReLaX.."Ali:Constructor:"..ChatId) or 0
local BanedList = DevAli:scard(ReLaX.."Ali:Ban:"..ChatId) or 0
local ManagerList = DevAli:scard(ReLaX.."Ali:Managers:"..ChatId) or 0
local MutedList = DevAli:scard(ReLaX.."Ali:Muted:"..ChatId) or 0
local TkeedList = DevAli:scard(ReLaX.."Ali:Ali:Tkeed:"..ChatId) or 0
local AdminsList = DevAli:scard(ReLaX.."Ali:Admins:"..ChatId) or 0
local VipList = DevAli:scard(ReLaX.."Ali:VipMem:"..ChatId) or 0
...
ChatLeave(dp.id_, ReLaX)
DevAli:srem(ReLaX.."Ali:Groups", dp.id_)
else
...
DevAli:set(ReLaX..'Ali:Num:Add:Bot',Num) 
...
Alimoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ReLaXTEAM, 14, string.len(msg.sender_user_id_))
DevAli:del(ReLaX..'Ali:Lock:FreeBot'..ReLaX) 
end 
end
...
Alimoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ReLaXTEAM, 14, string.len(msg.sender_user_id_))
DevAli:set(ReLaX..'Ali:Lock:FreeBot'..ReLaX,true) 
end 
end
if ChatType == 'sp' or ChatType == 'gp'  then
...
Alimoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ReLaXTEAM, 14, string.len(msg.sender_user_id_))
DevAli:del(ReLaX..'Ali:Lock:Games'..msg.chat_id_) 
end
if text == 'تعطيل الالعاب' and Manager(msg) and ChCheck(msg) or text == 'تعطيل اللعبه' and Manager(msg) and ChCheck(msg) then  
local ReLaXTEAM = '⌁︙اهلا عزيزي ↫ '..AliRank(msg)..' \n⌁︙تم تعطيل الالعاب بنجاح'
Alimoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ReLaXTEAM, 14, string.len(msg.sender_user_id_))
DevAli:set(ReLaX..'Ali:Lock:Games'..msg.chat_id_,true)  
end
if text == "تفعيل الرابط" or text == "تفعيل جلب الرابط" then 
if Admin(msg) then
local ReLaXTEAM = '⌁︙اهلا عزيزي ↫ '..AliRank(msg)..' \n⌁︙تم تفعيل جلب رابط المجموعه'
Alimoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ReLaXTEAM, 14, string.len(msg.sender_user_id_))
DevAli:del(ReLaX.."Ali:Lock:GpLinks"..msg.chat_id_)
return false  
end
end
...
Alimoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ReLaXTEAM, 14, string.len(msg.sender_user_id_))
DevAli:set(ReLaX.."Ali:Lock:GpLinks"..msg.chat_id_,"ok")
return false  
end
end
--     Source ReLaX     --
...
ReplyStatus(msg,result.id_,"ReplyBy","⌁︙تم تفعيل المجموعه "..dp.title_)  
DevAli:sadd(ReLaX.."Ali:Groups",msg.chat_id_)
if not DevAli:get(ReLaX..'Ali:SudosGp'..msg.sender_user_id_..msg.chat_id_) and not SecondSudo(msg) then 
DevAli:incrby(ReLaX..'Ali:Sudos'..msg.sender_user_id_,1)
DevAli:set(ReLaX..'Ali:SudosGp'..msg.sender_user_id_..msg.chat_id_,"Ali")
end
local Name1 = result.first_name_
local Name1 = Name1:gsub('"',"") 
local Name1 = Name1:gsub("'","") 
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,dp) 
if not DevAli:sismember(ReLaX..'Ali:Groups',msg.chat_id_) then
...
local curl = 'curl "' .. ALLII .. '" -F "chat_id=' .. msg.chat_id_ .. '" -F "document=@' .. 'GroupsBot.txt' .. '"'
io.popen(curl)
end
end
end
...
AliText = "الرساله"
send(v, 0,"["..msg.content_.text_.."]") 
DevAli:set(ReLaX..'Ali:PinnedMsgs'..v,msg.content_.text_) 
end
elseif msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
photo = msg.content_.photo_.sizes_[0].photo_.persistent_id_
...
AliText = "الصوره"
sendPhoto(v, 0, 0, 1, nil, photo,(msg.content_.caption_ or ''))
DevAli:set(ReLaX..'Ali:PinnedMsgs'..v,photo) 
end 
elseif msg.content_.animation_ then
for k,v in pairs(List) do 
AliText = "المتحركه"
sendDocument(v, 0, 0, 1,nil, msg.content_.animation_.animation_.persistent_id_,(msg.content_.caption_ or ''))    
DevAli:set(ReLaX..'Ali:PinnedMsgs'..v,msg.content_.animation_.animation_.persistent_id_)
end 
elseif msg.content_.video_ then
for k,v in pairs(List) do 
AliText = "الفيديو"
sendVideo(v, 0, 0, 1, nil, msg.content_.video_.video_.persistent_id_,(msg.content_.caption_ or '')) 
DevAli:set(ReLaX..'Ali:PinnedMsgs'..v,msg.content_.video_.video_.persistent_id_)
end 
elseif msg.content_.voice_ then
for k,v in pairs(List) do 
AliText = "البصمه"
sendVoice(v, 0, 0, 1, nil, msg.content_.voice_.voice_.persistent_id_,(msg.content_.caption_ or '')) 
DevAli:set(ReLaX..'Ali:PinnedMsgs'..v,msg.content_.voice_.voice_.persistent_id_)
end 
elseif msg.content_.audio_ then
for k,v in pairs(List) do 
AliText = "الصوت"
sendAudio(v, 0, 0, 1, nil, msg.content_.audio_.audio_.persistent_id_,(msg.content_.caption_ or '')) 
DevAli:set(ReLaX..'Ali:PinnedMsgs'..v,msg.content_.audio_.audio_.persistent_id_)
end 
elseif msg.content_.document_ then
for k,v in pairs(List) do 
AliText = "الملف"
sendDocument(v, 0, 0, 1,nil, msg.content_.document_.document_.persistent_id_,(msg.content_.caption_ or ''))    
DevAli:set(ReLaX..'Ali:PinnedMsgs'..v,msg.content_.document_.document_.persistent_id_)
end 
elseif msg.content_.sticker_ then
for k,v in pairs(List) do 
AliText = "الملصق"
sendSticker(v, 0, 0, 1, nil, msg.content_.sticker_.sticker_.persistent_id_)   
DevAli:set(ReLaX..'Ali:PinnedMsgs'..v,msg.content_.sticker_.sticker_.persistent_id_) 
end 
end
...
DevAli:set(ReLaX.."Ali:Add:AllRed"..msg.sender_user_id_,'SetAllRed')
Dev_Ali(msg.chat_id_, msg.id_, 1, "⌁︙حسنا ارسل الكلمه الان " ,  1, "md")
return false
end
if text and text:match("^(.*)$") then
...
DevAli:sadd(ReLaX.."Ali:Sudo:AllRed",text)
DevAli:set(ReLaX.."DelSudoRep",text)
return false 
end end
--     Source ReLaX     --
...
dp = 'متحركه 🎭'
elseif DevAli:get(ReLaX.."Ali:Voice:GpRed"..v..msg.chat_id_) then
dp = 'بصمه 🎙'
elseif DevAli:get(ReLaX.."Ali:Stecker:GpRed"..v..msg.chat_id_) then
dp = 'ملصق 🃏'
elseif DevAli:get(ReLaX.."Ali:Text:GpRed"..v..msg.chat_id_) then
dp = 'رساله ✉'
elseif DevAli:get(ReLaX.."Ali:Photo:GpRed"..v..msg.chat_id_) then
dp = 'صوره 🎇'
elseif DevAli:get(ReLaX.."Ali:Video:GpRed"..v..msg.chat_id_) then
dp = 'فيديو 📽'
elseif DevAli:get(ReLaX.."Ali:File:GpRed"..v..msg.chat_id_) then
dp = 'ملف 📁'
...
for k,v in pairs(redod) do
DevAli:del(ReLaX..'Ali:Gif:GpRed'..v..msg.chat_id_)
DevAli:del(ReLaX..'Ali:Voice:GpRed'..v..msg.chat_id_)
DevAli:del(ReLaX..'Ali:Audio:GpRed'..v..msg.chat_id_)
DevAli:del(ReLaX..'Ali:Photo:GpRed'..v..msg.chat_id_)
DevAli:del(ReLaX..'Ali:Stecker:GpRed'..v..msg.chat_id_)
DevAli:del(ReLaX..'Ali:Video:GpRed'..v..msg.chat_id_)
DevAli:del(ReLaX..'Ali:File:GpRed'..v..msg.chat_id_)
DevAli:del(ReLaX..'Ali:Text:GpRed'..v..msg.chat_id_)
DevAli:del(ReLaX..'Ali:Manager:GpRed'..msg.chat_id_)
end
...
MsgRep = '⌁︙ردود المطور ↫ ⤈ \n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉\n'
for k,v in pairs(redod) do
if DevAli:get(ReLaX.."Ali:Gif:AllRed"..v) then
dp = 'متحركه 🎭'
elseif DevAli:get(ReLaX.."Ali:Voice:AllRed"..v) then
dp = 'بصمه 🎙'
elseif DevAli:get(ReLaX.."Ali:Stecker:AllRed"..v) then
dp = 'ملصق 🃏'
elseif DevAli:get(ReLaX.."Ali:Text:AllRed"..v) then
dp = 'رساله ✉'
elseif DevAli:get(ReLaX.."Ali:Photo:AllRed"..v) then
dp = 'صوره 🎇'
elseif DevAli:get(ReLaX.."Ali:Video:AllRed"..v) then
dp = 'فيديو 📽'
elseif DevAli:get(ReLaX.."Ali:File:AllRed"..v) then
dp = 'ملف 📁'
...
for k,v in pairs(redod) do
DevAli:del(ReLaX.."Ali:Add:AllRed"..v)
DevAli:del(ReLaX.."Ali:Gif:AllRed"..v)
DevAli:del(ReLaX.."Ali:Voice:AllRed"..v)
DevAli:del(ReLaX.."Ali:Audio:AllRed"..v)
DevAli:del(ReLaX.."Ali:Photo:AllRed"..v)
DevAli:del(ReLaX.."Ali:Stecker:AllRed"..v)
DevAli:del(ReLaX.."Ali:Video:AllRed"..v)
DevAli:del(ReLaX.."Ali:File:AllRed"..v)
DevAli:del(ReLaX.."Ali:Text:AllRed"..v)
DevAli:del(ReLaX.."Ali:Sudo:AllRed")
end
...
DevAli:set(ReLaX..'Ali:Help0'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
...
DevAli:set(ReLaX..'Ali:Help01'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
...
DevAli:set(ReLaX..'Ali:Help21'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
...
DevAli:set(ReLaX..'Ali:Help31'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
...
DevAli:set(ReLaX..'Ali:Help41'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
...
DevAli:set(ReLaX..'Ali:Help51'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
...
DevAli:set(ReLaX..'Ali:Help61'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
...
DevAli:del(ReLaX..'Ali:Text:BotWelcome')
DevAli:del(ReLaX..'Ali:Photo:BotWelcome')
return false
end 
...
DevAli:del(ReLaX..'Ali:Lock:BotWelcome')
return false
end 
...
DevAli:set(ReLaX..'Ali:Lock:BotWelcome',true)
return false
end 
...
DevAli:del(ReLaX..'Ali:Text:BotWelcome')
DevAli:del(ReLaX..'Ali:Photo:BotWelcome')
DevAli:set(ReLaX.."Ali:Set:BotWelcome"..msg.sender_user_id_,"Text") 
return false
end 
if text and DevAli:get(ReLaX.."Ali:Set:BotWelcome"..msg.sender_user_id_) == 'Text' then 
if text and text:match("^الغاء$") then 
Dev_Ali(msg.chat_id_, msg.id_, 1, "⌁︙تم الغاء الامر", 1, "md") 
DevAli:del(ReLaX.."Ali:Set:BotWelcome"..msg.sender_user_id_)   
return false
end 
Dev_Ali(msg.chat_id_, msg.id_, 1, "⌁︙تم حفظ النص ارسل لي صورة الترحيب\n⌁︙ارسل ↫ الغاء لحفظ النص فقط", 1, 'md')   
DevAli:set(ReLaX.."Ali:Text:BotWelcome",text) 
DevAli:set(ReLaX.."Ali:Set:BotWelcome"..msg.sender_user_id_,"Photo") 
return false 
end 
if DevAli:get(ReLaX.."Ali:Set:BotWelcome"..msg.sender_user_id_) == 'Photo' then 
if text and text:match("^الغاء$") then 
...
DevAli:set(ReLaX.."Ali:Photo:BotWelcome",msg.content_.photo_.sizes_[1].photo_.persistent_id_)
...
DevAli:incr(ReLaX..'Ali:EditMsg'..result.chat_id_..result.sender_user_id_)
local text = result.content_.text_ or result.content_.caption_
local Text = result.content_.text_
if DevAli:get(ReLaX..'Ali:Lock:EditMsgs'..msg.chat_id_) and not Text and not BasicConstructor(result) then
...
local GetMsgPin = DevAli:get(ReLaX..'Ali:PinnedMsgs'..msg.chat_id_)
if GetMsgPin ~= nil then
if text == GetMsgPin then
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,dp) if dp.ID == 'Ok' then;DevAli:del(ReLaX..'Ali:PinnedMsgs'..msg.chat_id_);end;end,nil)   
elseif (msg.content_.sticker_) then 
if GetMsgPin == msg.content_.sticker_.sticker_.persistent_id_ then
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,dp) DevAli:del(ReLaX..'Ali:PinnedMsgs'..msg.chat_id_) end,nil)   
end
end
if (msg.content_.animation_) then 
...
if data and data.type_ and data.type_.channel_ and data.type_.channel_.status_ and data.type_.channel_.status_.ID == "ChatMemberStatusMember" then
tdcli_function({ID = "ChangeChatMemberStatus",chat_id_=v,user_id_=ReLaX,status_={ID = "ChatMemberStatusLeft"},},function(e,g) end, nil) 
DevAli:srem(ReLaX..'Ali:Groups',v)  
end
if data and data.type_ and data.type_.channel_ and data.type_.channel_.status_ and data.type_.channel_.status_.ID == "ChatMemberStatusLeft" then
DevAli:srem(ReLaX..'Ali:Groups',v)  
end
...
DevAli:sadd(ReLaX..'Ali:Groups',v)  
end end,nil) end
end
--     Source ReLaX     --
end 
